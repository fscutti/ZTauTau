...
"""
mGRL = ["276262","276329","276336","276416","276511","276689",
...
#-----------------------------------------------------------------------------
"""
PoPy8_Wminusenu   = Sample( name =  "PoPy8_Wminusenu",    xsec = )
PoPy8_Wminusmunu  = Sample( name =  "PoPy8_Wminusmunu",   xsec = )
PoPy8_Wminustaunu = Sample( name =  "PoPy8_Wminustaunu",  xsec = )
PoPy8_Wplusenu    = Sample( name =  "PoPy8_Wplusenu",     xsec = )
PoPy8_Wplusmunu   = Sample( name =  "PoPy8_Wplusmunu",    xsec = )
PoPy8_Wplustaunu  = Sample( name =  "PoPy8_Wplustaunu",   xsec = )
"""
...
#-----------------------------------------------------------------------------
"""
PoPy8_Zee   = Sample( name =  "PoPy8_Zee",    xsec = )
PoPy8_Zmumu = Sample( name =  "PoPy8_Zmumu",  xsec = )
PoPy8_Ztt   = Sample( name =  "PoPy8_Ztt",    xsec = )
"""
