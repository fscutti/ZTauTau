...
"""
f = ROOT.TFile('../../test/hists_tau_pt_SR.root')
hist_SR_subztt_pretrig1 = f.Get('h_SR_nominal_sub_ztt')

#g = ROOT.TFile('../../test/hists_tau_pt_SR_25med.root')
#hist_SR_subztt_posttrig1 = g.Get('h_SR_25med_nominal_sub_ztt_25med')

g = ROOT.TFile('../../test/35med/hists_tau_pt_SR_35med.root')
hist_SR_subztt_posttrig1 = g.Get('h_SR_35med_nominal_sub_ztt_35med')

h = ROOT.TFile('../../test/hists_tau_pt_SR_MC.root')
hist_SR_MC_pretrig1 = h.Get('h_SR_nominal_Zttjets')

#i = ROOT.TFile('../../test/hists_tau_pt_SR_25med_MC.root')
#hist_SR_MC_posttrig1 = i.Get('h_SR_25med_nominal_Zttjets')

i = ROOT.TFile('../../test/35med/hists_tau_pt_SR_35med_MC.root')
hist_SR_MC_posttrig1 = i.Get('h_SR_35med_nominal_Zttjets')


#    ONE PRONG

f = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_Tau1Track_data.root')
hist_SR_subztt_pretrig1 = f.Get('h_SR_Tau1Track_nominal_sub_ztt_1Track')

#g = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_25med_Tau1Track_data.root')
#hist_SR_subztt_posttrig1 = g.Get('h_SR_25med_Tau1Track_nominal_sub_ztt_25med_1Track')

g = ROOT.TFile('../../test/35med/hists_tau_pt_SR_35med_Tau1Track_data.root')
hist_SR_subztt_posttrig1 = g.Get('h_SR_35med_Tau1Track_nominal_sub_ztt_35med_1Track')

h = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_Tau1Track_MC.root')
hist_SR_MC_pretrig1 = h.Get('h_SR_Tau1Track_nominal_Zttjets')

#i = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_25med_Tau1Track_MC.root')
#hist_SR_MC_posttrig1 = i.Get('h_SR_25med_Tau1Track_nominal_Zttjets')

i = ROOT.TFile('../../test/35med/hists_tau_pt_SR_35med_Tau1Track_MC.root')
hist_SR_MC_posttrig1 = i.Get('h_SR_35med_Tau1Track_nominal_Zttjets')
"""

#    THREE PRONG

f = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_Tau3Track_data.root')
hist_SR_subztt_pretrig1 = f.Get('h_SR_Tau3Track_nominal_sub_ztt_3Track')

#g = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_25med_Tau3Track_data.root')
#hist_SR_subztt_posttrig1 = g.Get('h_SR_25med_Tau3Track_nominal_sub_ztt_25med_3Track')

g = ROOT.TFile('../../test/35med/hists_tau_pt_SR_35med_Tau3Track_data.root')
hist_SR_subztt_posttrig1 = g.Get('h_SR_35med_Tau3Track_nominal_sub_ztt_35med_3Track')

h = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_Tau3Track_MC.root')
hist_SR_MC_pretrig1 = h.Get('h_SR_Tau3Track_nominal_Zttjets')

#i = ROOT.TFile('../../test/efficiency_1_3prong/hists_tau_pt_SR_25med_Tau3Track_MC.root')
#hist_SR_MC_posttrig1 = i.Get('h_SR_25med_Tau3Track_nominal_Zttjets')

i = ROOT.TFile('../../test/35med/hists_tau_pt_SR_35med_Tau3Track_MC.root')
...
hist_SR_subztt_pretrig = hist_SR_subztt_pretrig1.Rebin(9,"hist_SR_subztt_pretrig",array.array('d',xlow))
hist_SR_subztt_posttrig = hist_SR_subztt_posttrig1.Rebin(9,"hist_SR_subztt_posttrig",array.array('d',xlow))
hist_SR_MC_pretrig = hist_SR_MC_pretrig1.Rebin(9,"hist_SR_MC_pretrig",array.array('d',xlow))
hist_SR_MC_posttrig = hist_SR_MC_posttrig1.Rebin(9,"hist_SR_MC_posttrig",array.array('d',xlow))
'''
...
tlatex.DrawLatex(tx,latex_yb,'HLT_tau35_medium1_tracktwo')
tlatex.SetTextSize=0.001
pad2.cd()
...
h_ratio.Draw("Same")
pad2.RedrawAxis()
plotsfile = os.path.join("./","threeprong.root")
#c.SaveAs("Test")
