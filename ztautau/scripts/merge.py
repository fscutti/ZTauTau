...
mc_backgrounds.append(samples.Zttjets_antitruth)
mc_backgrounds.append(samples.top_antitruth)

## signals
mc_signals = []
mc_signals.append(samples.Zttjets_truth)
mc_signals.append(samples.top_truth)

all_fake_backgrounds_list = []
fakes_background = samples.all_fake_backgrounds.copy()
all_fake_backgrounds_list.append(fakes_background)

fakes_background_25med = samples.all_fake_backgrounds.copy()
fakes_background_1Track = samples.all_fake_backgrounds.copy()
fakes_background_3Track = samples.all_fake_backgrounds.copy()
fakes_background_25med_1Track = samples.all_fake_backgrounds.copy()
fakes_background_25med_3Track = samples.all_fake_backgrounds.copy()

truth_taus = samples.truth_taus.copy()
...
addon_top_truth_OS_no_cuts     = samples.addon_top_truth.copy()
addon_top_antitruth_OS_no_cuts     = samples.addon_top_antitruth.copy()
addon_top_OS_no_cuts     = samples.addon_top.copy()
addon_Zttjets_antitruth_OS_no_cuts     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_OS_no_cuts     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_highSCDP_highMT     = samples.addon_top_truth.copy()
addon_top_antitruth_highSCDP_highMT     = samples.addon_top_antitruth.copy()
addon_top_highSCDP_highMT     = samples.addon_top.copy()
addon_Zttjets_antitruth_highSCDP_highMT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_highSCDP_highMT     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_lowSCDP_highMT     = samples.addon_top_truth.copy()
addon_top_antitruth_lowSCDP_highMT     = samples.addon_top_antitruth.copy()
addon_top_lowSCDP_highMT     = samples.addon_top.copy()
addon_Zttjets_antitruth_lowSCDP_highMT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowSCDP_highMT     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_lowSCDP_lowMT     = samples.addon_top_truth.copy()
addon_top_antitruth_lowSCDP_lowMT     = samples.addon_top_antitruth.copy()
addon_top_lowSCDP_lowMT     = samples.addon_top.copy()
addon_Zttjets_antitruth_lowSCDP_lowMT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowSCDP_lowMT     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_lowSCDP     = samples.addon_top_truth.copy()
addon_top_antitruth_lowSCDP     = samples.addon_top_antitruth.copy()
addon_top_lowSCDP     = samples.addon_top.copy()
addon_Zttjets_antitruth_lowSCDP     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowSCDP     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_highSCDP     = samples.addon_top_truth.copy()
addon_top_antitruth_highSCDP     = samples.addon_top_antitruth.copy()
addon_top_highSCDP     = samples.addon_top.copy()
addon_Zttjets_antitruth_highSCDP     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_highSCDP     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth     = samples.addon_top_truth.copy()
addon_top     = samples.addon_top.copy()
addon_top_antitruth     = samples.addon_top_antitruth.copy()
addon_top     = samples.addon_top.copy()
addon_Zttjets_antitruth     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_lowPT     = samples.addon_top_truth.copy()
addon_top_antitruth_lowPT     = samples.addon_top_antitruth.copy()
addon_top_lowPT     = samples.addon_top.copy()
addon_Zttjets_antitruth_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowPT     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_highPT     = samples.addon_top_truth.copy()
addon_top_antitruth_highPT     = samples.addon_top_antitruth.copy()
addon_top_highPT     = samples.addon_top.copy()
addon_Zttjets_antitruth_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_highPT     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_25med     = samples.addon_top_truth.copy()
addon_top_antitruth_25med     = samples.addon_top_antitruth.copy()
addon_top_25med     = samples.addon_top.copy()
addon_Zttjets_antitruth_25med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_25med_lowPT     = samples.addon_top_truth.copy()
addon_top_antitruth_25med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_25med_lowPT     = samples.addon_top.copy()
addon_Zttjets_antitruth_25med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_lowPT     = samples.addon_Zttjets_truth.copy()
...
addon_top_truth_25med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_highPT     = samples.addon_top_antitruth.copy()
addon_top_25med_highPT     = samples.addon_top.copy()
...
addon_top_truth_35med     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med     = samples.addon_top_antitruth.copy()
addon_top_35med     = samples.addon_top.copy()
...
addon_top_truth_35med_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_35med_lowPT     = samples.addon_top.copy()
...
addon_top_truth_35med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_highPT     = samples.addon_top_antitruth.copy()
addon_top_35med_highPT     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_lowPT     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_highPT     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_highPT     = samples.addon_top.copy()
...
addon_top_truth_80med     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med     = samples.addon_top_antitruth.copy()
addon_top_80med     = samples.addon_top.copy()
...
addon_top_truth_80med_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_80med_lowPT     = samples.addon_top.copy()
...
addon_top_truth_80med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_highPT     = samples.addon_top_antitruth.copy()
addon_top_80med_highPT     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_lowPT     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_highPT     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_highPT     = samples.addon_top.copy()
...
addon_top_truth_125med     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med     = samples.addon_top_antitruth.copy()
addon_top_125med     = samples.addon_top.copy()
...
addon_top_truth_125med_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_125med_lowPT     = samples.addon_top.copy()
...
addon_top_truth_125med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_highPT     = samples.addon_top_antitruth.copy()
addon_top_125med_highPT     = samples.addon_top.copy()
...
addon_top_truth_160med     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med     = samples.addon_top_antitruth.copy()
addon_top_160med     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed     = samples.addon_top.copy()
...
addon_top_truth_160med_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_lowPT     = samples.addon_top_antitruth.copy()
addon_top_160med_lowPT     = samples.addon_top.copy()
...
addon_top_truth_160med_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_highPT     = samples.addon_top_antitruth.copy()
addon_top_160med_highPT     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_lowPT     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_lowPT     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_highPT     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_highPT     = samples.addon_top.copy()
...
addon_top_truth_ptonly     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly     = samples.addon_top_antitruth.copy()
addon_top_ptonly     = samples.addon_top.copy()
...
addon_top_truth_ptonly_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_lowPT     = samples.addon_top_antitruth.copy()
addon_top_ptonly_lowPT     = samples.addon_top.copy()
...
addon_top_truth_ptonly_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_highPT     = samples.addon_top_antitruth.copy()
addon_top_ptonly_highPT     = samples.addon_top.copy()
...
addon_top_truth_tracktwo     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo     = samples.addon_top_antitruth.copy()
addon_top_tracktwo     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_lowPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_lowPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_lowPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_lowPT     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_lowPT     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_highPT     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_highPT     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_highPT     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_highPT     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_highPT     = samples.addon_top.copy()
...
addon_top_truth_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_1Track     = samples.addon_top_antitruth.copy()
addon_top_1Track     = samples.addon_top.copy()

addon_data_lowSCDP_1Track    = samples.addon_data_1Track.copy()
addon_Wjets_lowSCDP_1Track   = samples.addon_Wjets_1Track.copy()
addon_Zlljets_lowSCDP_1Track = samples.addon_Zlljets_1Track.copy()
addon_top_truth_lowSCDP_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_lowSCDP_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowSCDP_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_lowSCDP_1Track     = samples.addon_top_antitruth.copy()
addon_top_lowSCDP_1Track     = samples.addon_top.copy()

addon_data_lowSCDP_3Track    = samples.addon_data_3Track.copy()
addon_Wjets_lowSCDP_3Track   = samples.addon_Wjets_3Track.copy()
addon_Zlljets_lowSCDP_3Track = samples.addon_Zlljets_3Track.copy()
addon_top_truth_lowSCDP_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_lowSCDP_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowSCDP_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_lowSCDP_3Track     = samples.addon_top_antitruth.copy()
addon_top_lowSCDP_3Track     = samples.addon_top.copy()
...
addon_top_truth_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_25med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_1Track     = samples.addon_top_antitruth.copy()
addon_top_25med_1Track     = samples.addon_top.copy()
...
addon_top_truth_25med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_25med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_25med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_25med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_35med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_1Track     = samples.addon_top_antitruth.copy()
addon_top_35med_1Track     = samples.addon_top.copy()
...
addon_top_truth_35med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_35med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_35med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_35med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_1Track     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_1Track     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_80med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_1Track     = samples.addon_top_antitruth.copy()
addon_top_80med_1Track     = samples.addon_top.copy()
...
addon_top_truth_80med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_80med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_80med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_80med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_1Track     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_1Track     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_125med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_1Track     = samples.addon_top_antitruth.copy()
addon_top_125med_1Track     = samples.addon_top.copy()
...
addon_top_truth_125med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_125med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_125med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_125med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_160med_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_1Track     = samples.addon_top_antitruth.copy()
addon_top_160med_1Track     = samples.addon_top.copy()
...
addon_top_truth_160med_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_160med_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_160med_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_160med_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_1Track     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_1Track     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_ptonly_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_1Track     = samples.addon_top_antitruth.copy()
addon_top_ptonly_1Track     = samples.addon_top.copy()
...
addon_top_truth_ptonly_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_ptonly_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_ptonly_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_ptonly_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_1Track     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_1Track     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_lowPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_lowPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_lowPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_lowPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_lowPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_highPT_1Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_highPT_1Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_highPT_1Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_highPT_1Track     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_highPT_1Track     = samples.addon_top.copy()
...
addon_top_truth_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_3Track     = samples.addon_top_antitruth.copy()
addon_top_3Track     = samples.addon_top.copy()
...
addon_top_truth_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_25med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_3Track     = samples.addon_top_antitruth.copy()
addon_top_25med_3Track     = samples.addon_top.copy()
...
addon_top_truth_25med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_25med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_25med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_25med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_25med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_25med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_25med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_35med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_3Track     = samples.addon_top_antitruth.copy()
addon_top_35med_3Track     = samples.addon_top.copy()
...
addon_top_truth_35med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_35med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_35med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_35med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_35med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_35med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_35med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_3Track     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_3Track     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_50L1TAU12med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_50L1TAU12med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_50L1TAU12med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_50L1TAU12med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_50L1TAU12med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_80med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_3Track     = samples.addon_top_antitruth.copy()
addon_top_80med_3Track     = samples.addon_top.copy()
...
addon_top_truth_80med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_80med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_80med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_80med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_3Track     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_3Track     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_80L1TAU60med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_80L1TAU60med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_80L1TAU60med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_80L1TAU60med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_80L1TAU60med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_125med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_3Track     = samples.addon_top_antitruth.copy()
addon_top_125med_3Track     = samples.addon_top.copy()
...
addon_top_truth_125med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_125med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_125med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_125med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_125med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_125med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_125med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_160med_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_3Track     = samples.addon_top_antitruth.copy()
addon_top_160med_3Track     = samples.addon_top.copy()
...
addon_top_truth_160med_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_160med_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_160med_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_160med_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_160med_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_160med_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_160med_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_3Track     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_3Track     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_L1TAU12IMmed_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_L1TAU12IMmed_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_L1TAU12IMmed_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_L1TAU12IMmed_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_L1TAU12IMmed_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_ptonly_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_3Track     = samples.addon_top_antitruth.copy()
addon_top_ptonly_3Track     = samples.addon_top.copy()
...
addon_top_truth_ptonly_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_ptonly_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_ptonly_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_ptonly_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_ptonly_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_ptonly_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_ptonly_highPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_3Track     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_3Track     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_lowPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_lowPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_lowPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_lowPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_lowPT_3Track     = samples.addon_top.copy()
...
addon_top_truth_tracktwo_highPT_3Track     = samples.addon_top_truth.copy()
addon_Zttjets_antitruth_tracktwo_highPT_3Track     = samples.addon_Zttjets_antitruth.copy()
addon_Zttjets_truth_tracktwo_highPT_3Track     = samples.addon_Zttjets_truth.copy()
addon_top_antitruth_tracktwo_highPT_3Track     = samples.addon_top_antitruth.copy()
addon_top_tracktwo_highPT_3Track     = samples.addon_top.copy()
...
addon_backgrounds_highSCDP.append(addon_Zttjets_antitruth_highSCDP)
addon_backgrounds_highSCDP.append(addon_top_antitruth_highSCDP)
...
addon_backgrounds_lowSCDP.append(addon_Zttjets_antitruth_lowSCDP)
addon_backgrounds_lowSCDP.append(addon_top_antitruth_lowSCDP)
...
addon_backgrounds_lowSCDP_highMT.append(addon_Zttjets_antitruth_lowSCDP_highMT)
addon_backgrounds_lowSCDP_highMT.append(addon_top_antitruth_lowSCDP_highMT)
...
addon_backgrounds_highSCDP_highMT.append(addon_Zttjets_antitruth_highSCDP_highMT)
addon_backgrounds_highSCDP_highMT.append(addon_top_antitruth_highSCDP_highMT)
...
addon_backgrounds_OS_no_cuts.append(addon_Zttjets_antitruth_OS_no_cuts)
addon_backgrounds_OS_no_cuts.append(addon_top_antitruth_OS_no_cuts)
...
addon_backgrounds.append(addon_Zttjets_antitruth)
addon_backgrounds.append(addon_top_antitruth)
...
addon_backgrounds_lowPT.append(addon_Zttjets_antitruth_lowPT)
addon_backgrounds_lowPT.append(addon_top_antitruth_lowPT)
...
addon_backgrounds_highPT.append(addon_Zttjets_antitruth_highPT)
addon_backgrounds_highPT.append(addon_top_antitruth_highPT)
...
addon_backgrounds_25med.append(addon_Zttjets_antitruth_25med)
addon_backgrounds_25med.append(addon_top_antitruth_25med)
...
addon_backgrounds_25med_lowPT.append(addon_Zttjets_antitruth_25med_lowPT)
addon_backgrounds_25med_lowPT.append(addon_top_antitruth_25med_lowPT)
...
addon_backgrounds_25med_highPT.append(addon_Zttjets_antitruth_25med_highPT)
addon_backgrounds_25med_highPT.append(addon_top_antitruth_25med_highPT)
...
addon_backgrounds_35med.append(addon_Zttjets_antitruth_35med)
addon_backgrounds_35med.append(addon_top_antitruth_35med)
...
addon_backgrounds_35med_lowPT.append(addon_Zttjets_antitruth_35med_lowPT)
addon_backgrounds_35med_lowPT.append(addon_top_antitruth_35med_lowPT)
...
addon_backgrounds_35med_highPT.append(addon_Zttjets_antitruth_35med_highPT)
addon_backgrounds_35med_highPT.append(addon_top_antitruth_35med_highPT)
...
addon_backgrounds_50L1TAU12med.append(addon_Zttjets_antitruth_50L1TAU12med)
addon_backgrounds_50L1TAU12med.append(addon_top_antitruth_50L1TAU12med)
...
addon_backgrounds_50L1TAU12med_lowPT.append(addon_Zttjets_antitruth_50L1TAU12med_lowPT)
addon_backgrounds_50L1TAU12med_lowPT.append(addon_top_antitruth_50L1TAU12med_lowPT)
...
addon_backgrounds_50L1TAU12med_highPT.append(addon_Zttjets_antitruth_50L1TAU12med_highPT)
addon_backgrounds_50L1TAU12med_highPT.append(addon_top_antitruth_50L1TAU12med_highPT)
...
addon_backgrounds_80med.append(addon_Zttjets_antitruth_80med)
addon_backgrounds_80med.append(addon_top_antitruth_80med)
...
addon_backgrounds_80med_lowPT.append(addon_Zttjets_antitruth_80med_lowPT)
addon_backgrounds_80med_lowPT.append(addon_top_antitruth_80med_lowPT)
...
addon_backgrounds_80med_highPT.append(addon_Zttjets_antitruth_80med_highPT)
addon_backgrounds_80med_highPT.append(addon_top_antitruth_80med_highPT)
...
addon_backgrounds_80L1TAU60med.append(addon_Zttjets_antitruth_80L1TAU60med)
addon_backgrounds_80L1TAU60med.append(addon_top_antitruth_80L1TAU60med)
...
addon_backgrounds_80L1TAU60med_lowPT.append(addon_Zttjets_antitruth_80L1TAU60med_lowPT)
addon_backgrounds_80L1TAU60med_lowPT.append(addon_top_antitruth_80L1TAU60med_lowPT)
...
addon_backgrounds_80L1TAU60med_highPT.append(addon_Zttjets_antitruth_80L1TAU60med_highPT)
addon_backgrounds_80L1TAU60med_highPT.append(addon_top_antitruth_80L1TAU60med_highPT)
...
addon_backgrounds_125med.append(addon_Zttjets_antitruth_125med)
addon_backgrounds_125med.append(addon_top_antitruth_125med)
...
addon_backgrounds_125med_lowPT.append(addon_Zttjets_antitruth_125med_lowPT)
addon_backgrounds_125med_lowPT.append(addon_top_antitruth_125med_lowPT)
...
addon_backgrounds_125med_highPT.append(addon_Zttjets_antitruth_125med_highPT)
addon_backgrounds_125med_highPT.append(addon_top_antitruth_125med_highPT)
...
addon_backgrounds_160med.append(addon_Zttjets_antitruth_160med)
addon_backgrounds_160med.append(addon_top_antitruth_160med)
...
addon_backgrounds_160med_lowPT.append(addon_Zttjets_antitruth_160med_lowPT)
addon_backgrounds_160med_lowPT.append(addon_top_antitruth_160med_lowPT)
...
addon_backgrounds_160med_highPT.append(addon_Zttjets_antitruth_160med_highPT)
addon_backgrounds_160med_highPT.append(addon_top_antitruth_160med_highPT)
...
addon_backgrounds_L1TAU12IMmed.append(addon_Zttjets_antitruth_L1TAU12IMmed)
addon_backgrounds_L1TAU12IMmed.append(addon_top_antitruth_L1TAU12IMmed)
...
addon_backgrounds_L1TAU12IMmed_lowPT.append(addon_Zttjets_antitruth_L1TAU12IMmed_lowPT)
addon_backgrounds_L1TAU12IMmed_lowPT.append(addon_top_antitruth_L1TAU12IMmed_lowPT)
...
addon_backgrounds_L1TAU12IMmed_highPT.append(addon_Zttjets_antitruth_L1TAU12IMmed_highPT)
addon_backgrounds_L1TAU12IMmed_highPT.append(addon_top_antitruth_L1TAU12IMmed_highPT)
...
addon_backgrounds_ptonly.append(addon_Zttjets_antitruth_ptonly)
addon_backgrounds_ptonly.append(addon_top_antitruth_ptonly)
...
addon_backgrounds_ptonly_lowPT.append(addon_Zttjets_antitruth_ptonly_lowPT)
addon_backgrounds_ptonly_lowPT.append(addon_top_antitruth_ptonly_lowPT)
...
addon_backgrounds_ptonly_highPT.append(addon_Zttjets_antitruth_ptonly_highPT)
addon_backgrounds_ptonly_highPT.append(addon_top_antitruth_ptonly_highPT)
...
addon_backgrounds_tracktwo.append(addon_Zttjets_antitruth_tracktwo)
addon_backgrounds_tracktwo.append(addon_top_antitruth_tracktwo)
...
addon_backgrounds_tracktwo_lowPT.append(addon_Zttjets_antitruth_tracktwo_lowPT)
addon_backgrounds_tracktwo_lowPT.append(addon_top_antitruth_tracktwo_lowPT)
...
addon_backgrounds_tracktwo_highPT.append(addon_Zttjets_antitruth_tracktwo_highPT)
addon_backgrounds_tracktwo_highPT.append(addon_top_antitruth_tracktwo_highPT)

#--------------------------
# one track
#--------------------------

addon_backgrounds_lowSCDP_1Track = []
addon_backgrounds_lowSCDP_1Track.append(addon_data_lowSCDP_1Track)
addon_backgrounds_lowSCDP_1Track.append(addon_Wjets_lowSCDP_1Track)
addon_backgrounds_lowSCDP_1Track.append(addon_Zlljets_lowSCDP_1Track)
addon_backgrounds_lowSCDP_1Track.append(addon_Zttjets_antitruth_lowSCDP_1Track)
addon_backgrounds_lowSCDP_1Track.append(addon_top_antitruth_lowSCDP_1Track)
...
addon_backgrounds_lowPT_1Track.append(addon_Zttjets_antitruth_lowPT_1Track)
addon_backgrounds_lowPT_1Track.append(addon_top_antitruth_lowPT_1Track)
...
addon_backgrounds_highPT_1Track.append(addon_Zttjets_antitruth_highPT_1Track)
addon_backgrounds_highPT_1Track.append(addon_top_antitruth_highPT_1Track)
...
addon_backgrounds_1Track.append(addon_Zttjets_antitruth_1Track)
addon_backgrounds_1Track.append(addon_top_antitruth_1Track)
...
addon_backgrounds_25med_1Track.append(addon_Zttjets_antitruth_25med_1Track)
addon_backgrounds_25med_1Track.append(addon_top_antitruth_25med_1Track)
...
addon_backgrounds_25med_lowPT_1Track.append(addon_Zttjets_antitruth_25med_lowPT_1Track)
addon_backgrounds_25med_lowPT_1Track.append(addon_top_antitruth_25med_lowPT_1Track)
...
addon_backgrounds_25med_highPT_1Track.append(addon_Zttjets_antitruth_25med_highPT_1Track)
addon_backgrounds_25med_highPT_1Track.append(addon_top_antitruth_25med_highPT_1Track)
...
addon_backgrounds_35med_1Track.append(addon_Zttjets_antitruth_35med_1Track)
addon_backgrounds_35med_1Track.append(addon_top_antitruth_35med_1Track)
...
addon_backgrounds_35med_lowPT_1Track.append(addon_Zttjets_antitruth_35med_lowPT_1Track)
addon_backgrounds_35med_lowPT_1Track.append(addon_top_antitruth_35med_lowPT_1Track)
...
addon_backgrounds_35med_highPT_1Track.append(addon_Zttjets_antitruth_35med_highPT_1Track)
addon_backgrounds_35med_highPT_1Track.append(addon_top_antitruth_35med_highPT_1Track)
...
addon_backgrounds_50L1TAU12med_1Track.append(addon_Zttjets_antitruth_50L1TAU12med_1Track)
addon_backgrounds_50L1TAU12med_1Track.append(addon_top_antitruth_50L1TAU12med_1Track)
...
addon_backgrounds_50L1TAU12med_lowPT_1Track.append(addon_Zttjets_antitruth_50L1TAU12med_lowPT_1Track)
addon_backgrounds_50L1TAU12med_lowPT_1Track.append(addon_top_antitruth_50L1TAU12med_lowPT_1Track)
...
addon_backgrounds_50L1TAU12med_highPT_1Track.append(addon_Zttjets_antitruth_50L1TAU12med_highPT_1Track)
addon_backgrounds_50L1TAU12med_highPT_1Track.append(addon_top_antitruth_50L1TAU12med_highPT_1Track)
...
addon_backgrounds_80med_1Track.append(addon_Zttjets_antitruth_80med_1Track)
addon_backgrounds_80med_1Track.append(addon_top_antitruth_80med_1Track)
...
addon_backgrounds_80med_lowPT_1Track.append(addon_Zttjets_antitruth_80med_lowPT_1Track)
addon_backgrounds_80med_lowPT_1Track.append(addon_top_antitruth_80med_lowPT_1Track)
...
addon_backgrounds_80med_highPT_1Track.append(addon_Zttjets_antitruth_80med_highPT_1Track)
addon_backgrounds_80med_highPT_1Track.append(addon_top_antitruth_80med_highPT_1Track)
...
addon_backgrounds_80L1TAU60med_1Track.append(addon_Zttjets_antitruth_80L1TAU60med_1Track)
addon_backgrounds_80L1TAU60med_1Track.append(addon_top_antitruth_80L1TAU60med_1Track)
...
addon_backgrounds_80L1TAU60med_lowPT_1Track.append(addon_Zttjets_antitruth_80L1TAU60med_lowPT_1Track)
addon_backgrounds_80L1TAU60med_lowPT_1Track.append(addon_top_antitruth_80L1TAU60med_lowPT_1Track)
...
addon_backgrounds_80L1TAU60med_highPT_1Track.append(addon_Zttjets_antitruth_80L1TAU60med_highPT_1Track)
addon_backgrounds_80L1TAU60med_highPT_1Track.append(addon_top_antitruth_80L1TAU60med_highPT_1Track)
...
addon_backgrounds_125med_1Track.append(addon_Zttjets_antitruth_125med_1Track)
addon_backgrounds_125med_1Track.append(addon_top_antitruth_125med_1Track)
...
addon_backgrounds_125med_lowPT_1Track.append(addon_Zttjets_antitruth_125med_lowPT_1Track)
addon_backgrounds_125med_lowPT_1Track.append(addon_top_antitruth_125med_lowPT_1Track)
...
addon_backgrounds_125med_highPT_1Track.append(addon_Zttjets_antitruth_125med_highPT_1Track)
addon_backgrounds_125med_highPT_1Track.append(addon_top_antitruth_125med_highPT_1Track)
...
addon_backgrounds_160med_1Track.append(addon_Zttjets_antitruth_160med_1Track)
addon_backgrounds_160med_1Track.append(addon_top_antitruth_160med_1Track)
...
addon_backgrounds_L1TAU12IMmed_1Track.append(addon_Zttjets_antitruth_L1TAU12IMmed_1Track)
addon_backgrounds_L1TAU12IMmed_1Track.append(addon_top_antitruth_L1TAU12IMmed_1Track)
...
addon_backgrounds_160med_lowPT_1Track.append(addon_Zttjets_antitruth_160med_lowPT_1Track)
addon_backgrounds_160med_lowPT_1Track.append(addon_top_antitruth_160med_lowPT_1Track)
...
addon_backgrounds_160med_highPT_1Track.append(addon_Zttjets_antitruth_160med_highPT_1Track)
addon_backgrounds_160med_highPT_1Track.append(addon_top_antitruth_160med_highPT_1Track)
...
addon_backgrounds_L1TAU12IMmed_lowPT_1Track.append(addon_Zttjets_antitruth_L1TAU12IMmed_lowPT_1Track)
addon_backgrounds_L1TAU12IMmed_lowPT_1Track.append(addon_top_antitruth_L1TAU12IMmed_lowPT_1Track)
...
addon_backgrounds_L1TAU12IMmed_highPT_1Track.append(addon_Zttjets_antitruth_L1TAU12IMmed_highPT_1Track)
addon_backgrounds_L1TAU12IMmed_highPT_1Track.append(addon_top_antitruth_L1TAU12IMmed_highPT_1Track)
...
addon_backgrounds_ptonly_1Track.append(addon_Zttjets_antitruth_ptonly_1Track)
addon_backgrounds_ptonly_1Track.append(addon_top_antitruth_ptonly_1Track)
...
addon_backgrounds_ptonly_lowPT_1Track.append(addon_Zttjets_antitruth_ptonly_lowPT_1Track)
addon_backgrounds_ptonly_lowPT_1Track.append(addon_top_antitruth_ptonly_lowPT_1Track)
...
addon_backgrounds_ptonly_highPT_1Track.append(addon_Zttjets_antitruth_ptonly_highPT_1Track)
addon_backgrounds_ptonly_highPT_1Track.append(addon_top_antitruth_ptonly_highPT_1Track)
...
addon_backgrounds_tracktwo_1Track.append(addon_Zttjets_antitruth_tracktwo_1Track)
addon_backgrounds_tracktwo_1Track.append(addon_top_antitruth_tracktwo_1Track)
...
addon_backgrounds_tracktwo_lowPT_1Track.append(addon_Zttjets_antitruth_tracktwo_lowPT_1Track)
addon_backgrounds_tracktwo_lowPT_1Track.append(addon_top_antitruth_tracktwo_lowPT_1Track)
...
addon_backgrounds_tracktwo_highPT_1Track.append(addon_Zttjets_antitruth_tracktwo_highPT_1Track)
addon_backgrounds_tracktwo_highPT_1Track.append(addon_top_antitruth_tracktwo_highPT_1Track)

#--------------------------
# three tracks
#--------------------------

addon_backgrounds_lowSCDP_3Track = []
addon_backgrounds_lowSCDP_3Track.append(addon_data_lowSCDP_3Track)
addon_backgrounds_lowSCDP_3Track.append(addon_Wjets_lowSCDP_3Track)
addon_backgrounds_lowSCDP_3Track.append(addon_Zlljets_lowSCDP_3Track)
addon_backgrounds_lowSCDP_3Track.append(addon_Zttjets_antitruth_lowSCDP_3Track)
addon_backgrounds_lowSCDP_3Track.append(addon_top_antitruth_lowSCDP_3Track)
...
addon_backgrounds_lowPT_3Track.append(addon_Zttjets_antitruth_lowPT_3Track)
addon_backgrounds_lowPT_3Track.append(addon_top_antitruth_lowPT_3Track)
...
addon_backgrounds_highPT_3Track.append(addon_Zttjets_antitruth_highPT_3Track)
addon_backgrounds_highPT_3Track.append(addon_top_antitruth_highPT_3Track)
...
addon_backgrounds_3Track.append(addon_Zttjets_antitruth_3Track)
addon_backgrounds_3Track.append(addon_top_antitruth_3Track)
...
addon_backgrounds_25med_3Track.append(addon_Zttjets_antitruth_25med_3Track)
addon_backgrounds_25med_3Track.append(addon_top_antitruth_25med_3Track)
...
addon_backgrounds_25med_lowPT_3Track.append(addon_Zttjets_antitruth_25med_lowPT_3Track)
addon_backgrounds_25med_lowPT_3Track.append(addon_top_antitruth_25med_lowPT_3Track)
...
addon_backgrounds_25med_highPT_3Track.append(addon_Zttjets_antitruth_25med_highPT_3Track)
addon_backgrounds_25med_highPT_3Track.append(addon_top_antitruth_25med_highPT_3Track)
...
addon_backgrounds_35med_3Track.append(addon_Zttjets_antitruth_35med_3Track)
addon_backgrounds_35med_3Track.append(addon_top_antitruth_35med_3Track)
...
addon_backgrounds_35med_lowPT_3Track.append(addon_Zttjets_antitruth_35med_lowPT_3Track)
addon_backgrounds_35med_lowPT_3Track.append(addon_top_antitruth_35med_lowPT_3Track)
...
addon_backgrounds_35med_highPT_3Track.append(addon_Zttjets_antitruth_35med_highPT_3Track)
addon_backgrounds_35med_highPT_3Track.append(addon_top_antitruth_35med_highPT_3Track)
...
addon_backgrounds_50L1TAU12med_3Track.append(addon_Zttjets_antitruth_50L1TAU12med_3Track)
addon_backgrounds_50L1TAU12med_3Track.append(addon_top_antitruth_50L1TAU12med_3Track)
...
addon_backgrounds_50L1TAU12med_lowPT_3Track.append(addon_Zttjets_antitruth_50L1TAU12med_lowPT_3Track)
addon_backgrounds_50L1TAU12med_lowPT_3Track.append(addon_top_antitruth_50L1TAU12med_lowPT_3Track)
...
addon_backgrounds_50L1TAU12med_highPT_3Track.append(addon_Zttjets_antitruth_50L1TAU12med_highPT_3Track)
addon_backgrounds_50L1TAU12med_highPT_3Track.append(addon_top_antitruth_50L1TAU12med_highPT_3Track)
...
addon_backgrounds_80med_3Track.append(addon_Zttjets_antitruth_80med_3Track)
addon_backgrounds_80med_3Track.append(addon_top_antitruth_80med_3Track)
...
addon_backgrounds_80med_lowPT_3Track.append(addon_Zttjets_antitruth_80med_lowPT_3Track)
addon_backgrounds_80med_lowPT_3Track.append(addon_top_antitruth_80med_lowPT_3Track)
...
addon_backgrounds_80med_highPT_3Track.append(addon_Zttjets_antitruth_80med_highPT_3Track)
addon_backgrounds_80med_highPT_3Track.append(addon_top_antitruth_80med_highPT_3Track)
...
addon_backgrounds_80L1TAU60med_3Track.append(addon_Zttjets_antitruth_80L1TAU60med_3Track)
addon_backgrounds_80L1TAU60med_3Track.append(addon_top_antitruth_80L1TAU60med_3Track)
...
addon_backgrounds_80L1TAU60med_lowPT_3Track.append(addon_Zttjets_antitruth_80L1TAU60med_lowPT_3Track)
addon_backgrounds_80L1TAU60med_lowPT_3Track.append(addon_top_antitruth_80L1TAU60med_lowPT_3Track)
...
addon_backgrounds_80L1TAU60med_highPT_3Track.append(addon_Zttjets_antitruth_80L1TAU60med_highPT_3Track)
addon_backgrounds_80L1TAU60med_highPT_3Track.append(addon_top_antitruth_80L1TAU60med_highPT_3Track)
...
addon_backgrounds_125med_3Track.append(addon_Zttjets_antitruth_125med_3Track)
addon_backgrounds_125med_3Track.append(addon_top_antitruth_125med_3Track)
...
addon_backgrounds_125med_lowPT_3Track.append(addon_Zttjets_antitruth_125med_lowPT_3Track)
addon_backgrounds_125med_lowPT_3Track.append(addon_top_antitruth_125med_lowPT_3Track)
...
addon_backgrounds_125med_highPT_3Track.append(addon_Zttjets_antitruth_125med_highPT_3Track)
addon_backgrounds_125med_highPT_3Track.append(addon_top_antitruth_125med_highPT_3Track)
...
addon_backgrounds_160med_3Track.append(addon_Zttjets_antitruth_160med_3Track)
addon_backgrounds_160med_3Track.append(addon_top_antitruth_160med_3Track)
...
addon_backgrounds_160med_lowPT_3Track.append(addon_Zttjets_antitruth_160med_lowPT_3Track)
addon_backgrounds_160med_lowPT_3Track.append(addon_top_antitruth_160med_lowPT_3Track)
...
addon_backgrounds_160med_highPT_3Track.append(addon_Zttjets_antitruth_160med_highPT_3Track)
addon_backgrounds_160med_highPT_3Track.append(addon_top_antitruth_160med_highPT_3Track)
...
addon_backgrounds_L1TAU12IMmed_3Track.append(addon_Zttjets_antitruth_L1TAU12IMmed_3Track)
addon_backgrounds_L1TAU12IMmed_3Track.append(addon_top_antitruth_L1TAU12IMmed_3Track)
...
addon_backgrounds_L1TAU12IMmed_lowPT_3Track.append(addon_Zttjets_antitruth_L1TAU12IMmed_lowPT_3Track)
addon_backgrounds_L1TAU12IMmed_lowPT_3Track.append(addon_top_antitruth_L1TAU12IMmed_lowPT_3Track)
...
addon_backgrounds_L1TAU12IMmed_highPT_3Track.append(addon_Zttjets_antitruth_L1TAU12IMmed_highPT_3Track)
addon_backgrounds_L1TAU12IMmed_highPT_3Track.append(addon_top_antitruth_L1TAU12IMmed_highPT_3Track)
...
addon_backgrounds_ptonly_3Track.append(addon_Zttjets_antitruth_ptonly_3Track)
addon_backgrounds_ptonly_3Track.append(addon_top_antitruth_ptonly_3Track)
...
addon_backgrounds_ptonly_lowPT_3Track.append(addon_Zttjets_antitruth_ptonly_lowPT_3Track)
addon_backgrounds_ptonly_lowPT_3Track.append(addon_top_antitruth_ptonly_lowPT_3Track)
...
addon_backgrounds_ptonly_highPT_3Track.append(addon_Zttjets_antitruth_ptonly_highPT_3Track)
addon_backgrounds_ptonly_highPT_3Track.append(addon_top_antitruth_ptonly_highPT_3Track)
...
addon_backgrounds_tracktwo_3Track.append(addon_Zttjets_antitruth_tracktwo_3Track)
addon_backgrounds_tracktwo_3Track.append(addon_top_antitruth_tracktwo_3Track)
...
addon_backgrounds_tracktwo_lowPT_3Track.append(addon_Zttjets_antitruth_tracktwo_lowPT_3Track)
addon_backgrounds_tracktwo_lowPT_3Track.append(addon_top_antitruth_tracktwo_lowPT_3Track)
...
addon_backgrounds_tracktwo_highPT_3Track.append(addon_Zttjets_antitruth_tracktwo_highPT_3Track)
addon_backgrounds_tracktwo_highPT_3Track.append(addon_top_antitruth_tracktwo_highPT_3Track)
...
addon_regions_OS_no_cuts[samples.Wjets]   = {"OS":"Wjets_OS", "SS":"Wjets_SS", "ncuts":3}
addon_regions_OS_no_cuts[samples.Zlljets] = {"OS":"Wjets_OS", "SS":"Wjets_SS", "ncuts":3}
addon_regions_OS_no_cuts[samples.Zttjets_antitruth]     = {"OS":"Wjets_OS", "SS":"Wjets_SS", "ncuts":3}
addon_regions_OS_no_cuts[samples.top_antitruth]     = {"OS":"Wjets_OS", "SS":"Wjets_SS", "ncuts":3}

addon_regions_lowSCDP = {}
addon_regions_lowSCDP[data]            = {"SS":"SR_SS_lowSCDP", "OS_lscdp":"SR_lowSCDP", "SS_lscdp":"SR_SS_lowSCDP", "OS":"SR_lowSCDP",  "ncuts":4}
...
addon_regions_lowSCDP[samples.Zttjets_antitruth]     = {"OS":"SR_lowSCDP", "SS":"SR_SS_lowSCDP", "ncuts":4}
addon_regions_lowSCDP[samples.top_antitruth]     = {"OS":"SR_lowSCDP", "SS":"SR_SS_lowSCDP", "ncuts":4}

addon_regions_lowSCDP_1Track = {}
addon_regions_lowSCDP_1Track[data]            = {"SS":"SR_lowSCDP_SS_Tau1Track", "OS":"SR_lowSCDP_Tau1Track", "OS_lscdp": "SR_lowSCDP_Tau1Track", "SS_lscdp":"SR_lowSCDP_SS_Tau1Track", "ncuts":5}
addon_regions_lowSCDP_1Track[samples.Wjets]   = {"OS":"SR_lowSCDP_Tau1Track", "SS":"SR_lowSCDP_SS_Tau1Track", "ncuts":5}
addon_regions_lowSCDP_1Track[samples.Zlljets] = {"OS":"SR_lowSCDP_Tau1Track", "SS":"SR_lowSCDP_SS_Tau1Track", "ncuts":5}
addon_regions_lowSCDP_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_lowSCDP_Tau1Track", "SS":"SR_lowSCDP_SS_Tau1Track", "ncuts":5}
addon_regions_lowSCDP_1Track[samples.top_antitruth]     = {"OS":"SR_lowSCDP_Tau1Track", "SS":"SR_lowSCDP_SS_Tau1Track", "ncuts":5}

addon_regions_lowSCDP_3Track = {}
addon_regions_lowSCDP_3Track[data]            = {"SS":"SR_lowSCDP_SS_Tau3Track", "OS":"SR_lowSCDP_Tau3Track", "OS_lscdp": "SR_lowSCDP_Tau3Track", "SS_lscdp":"SR_lowSCDP_SS_Tau3Track", "ncuts":5}
addon_regions_lowSCDP_3Track[samples.Wjets]   = {"OS":"SR_lowSCDP_Tau3Track", "SS":"SR_lowSCDP_SS_Tau3Track", "ncuts":5}
addon_regions_lowSCDP_3Track[samples.Zlljets] = {"OS":"SR_lowSCDP_Tau3Track", "SS":"SR_lowSCDP_SS_Tau3Track", "ncuts":5}
addon_regions_lowSCDP_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_lowSCDP_Tau3Track", "SS":"SR_lowSCDP_SS_Tau3Track", "ncuts":5}
addon_regions_lowSCDP_3Track[samples.top_antitruth]     = {"OS":"SR_lowSCDP_Tau3Track", "SS":"SR_lowSCDP_SS_Tau3Track", "ncuts":5}
...
addon_regions_highSCDP[samples.Zttjets_antitruth]     = {"OS":"SR_highSCDP", "SS":"SR_SS_highSCDP", "ncuts":3}
addon_regions_highSCDP[samples.top_antitruth]     = {"OS":"SR_highSCDP", "SS":"SR_SS_highSCDP", "ncuts":3}
...
addon_regions_lowSCDP_highMT[samples.Zttjets_antitruth]     = {"OS":"SR_lowSCDP_highMT", "SS":"SR_lowSCDP_highMT_SS", "ncuts":4}
addon_regions_lowSCDP_highMT[samples.top_antitruth]     = {"OS":"SR_lowSCDP_highMT", "SS":"SR_lowSCDP_highMT_SS", "ncuts":4}
...
addon_regions_highSCDP_highMT[samples.Zttjets_antitruth]     = {"OS":"SR_highSCDP_highMT", "SS":"SR_highSCDP_highMT_SS", "ncuts":4}
addon_regions_highSCDP_highMT[samples.top_antitruth]     = {"OS":"SR_highSCDP_highMT", "SS":"SR_highSCDP_highMT_SS", "ncuts":4}
...
addon_regions_lowSCDP_lowMT[samples.Zttjets_antitruth]     = {"OS":"SR_lowSCDP_lowMT", "SS":"SR_lowSCDP_lowMT_SS", "ncuts":4}
addon_regions_lowSCDP_lowMT[samples.top_antitruth]     = {"OS":"SR_lowSCDP_lowMT", "SS":"SR_lowSCDP_lowMT_SS", "ncuts":4}
...
addon_regions[samples.Zttjets_antitruth]     = {"OS":"SR", "SS":"SR_SS", "ncuts":4}
addon_regions[samples.top_antitruth]     = {"OS":"SR", "SS":"SR_SS", "ncuts":4}
...
#addon_regions_highPT[samples.Zttjets_antitruth]   = {"OS":"Wjets_OS_highPT", "SS":"Wjets_SS_highPT", "ncuts":4}# {"SS":"SR_SS_highPT", "ncuts":5}
#addon_regions_highPT[samples.Wjets]   = {"OS":"Wjets_OS_highPT", "SS":"Wjets_SS_highPT", "ncuts":4}# {"SS":"SR_SS_highPT", "ncuts":5}
#addon_regions_highPT[samples.Zlljets]   = {"OS":"Wjets_OS_highPT", "SS":"Wjets_SS_highPT", "ncuts":4}# {"SS":"SR_SS_highPT", "ncuts":5}
...
addon_regions_highPT[samples.top_antitruth]     = {"OS":"SR_highPT", "SS":"SR_SS_highPT", "ncuts":5}#{"OS":"SR_highPT", "SS":"SR_SS_highPT", "ncuts":5}
addon_regions_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_highPT", "SS":"SR_SS_highPT", "ncuts":5}#{"OS":"SR_highPT", "SS":"SR_SS_highPT", "ncuts":5}
...
#addon_regions_lowPT[samples.Wjets]   = {"OS":"Wjets_OS_lowPT", "SS":"Wjets_SS_lowPT", "ncuts":4}# {"SS":"SR_SS_highPT", "ncuts":5}
#addon_regions_lowPT[samples.Zlljets]   = {"OS":"Wjets_OS_lowPT", "SS":"Wjets_SS_lowPT", "ncuts":4}# {"SS":"SR_SS_highPT", "ncuts":5}
#addon_regions_lowPT[samples.top]   = {"OS":"Wjets_OS_lowPT", "SS":"Wjets_SS_lowPT", "ncuts":4}# {"SS":"SR_SS_highPT", "ncuts":5}
...
addon_regions_lowPT[samples.top_antitruth]     = {"OS":"SR_lowPT", "SS":"SR_SS_lowPT", "ncuts":5}#{"OS":"SR_lowPT", "SS":"SR_SS_lowPT", "ncuts":5}
addon_regions_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_lowPT", "SS":"SR_SS_lowPT", "ncuts":5}#{"OS":"SR_lowPT", "SS":"SR_SS_lowPT", "ncuts":5}
...
addon_regions_25med[samples.Zttjets_antitruth]     = {"OS":"SR_25med", "SS":"SR_SS25med", "ncuts":5}#{"OS":"SR_25med", "SS":"SR_SS25med", "ncuts":5}
addon_regions_25med[samples.top_antitruth]     = {"OS":"SR_25med", "SS":"SR_SS25med", "ncuts":5}#{"OS":"SR_25med", "SS":"SR_SS25med", "ncuts":5}
...
addon_regions_25med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_25med_lowPT", "SS":"SR_SS25med_lowPT", "ncuts":6}#{"OS":"SR_25med_lowPT", "SS":"SR_SS25med_lowPT", "ncuts":6}
addon_regions_25med_lowPT[samples.top_antitruth]     = {"OS":"SR_25med_lowPT", "SS":"SR_SS25med_lowPT", "ncuts":6}#{"OS":"SR_25med_lowPT", "SS":"SR_SS25med_lowPT", "ncuts":6}
...
addon_regions_25med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_25med_highPT", "SS":"SR_SS25med_highPT", "ncuts":6}#{"OS":"SR_25med_highPT", "SS":"SR_SS25med_highPT", "ncuts":6}
addon_regions_25med_highPT[samples.top_antitruth]     = {"OS":"SR_25med_highPT", "SS":"SR_SS25med_highPT", "ncuts":6}#{"OS":"SR_25med_highPT", "SS":"SR_SS25med_highPT", "ncuts":6}
...
addon_regions_35med[samples.Zttjets_antitruth]     = {"OS":"SR_35med", "SS":"SR_SS_35med", "ncuts":5}
addon_regions_35med[samples.top_antitruth]     = {"OS":"SR_35med", "SS":"SR_SS_35med", "ncuts":5}
...
addon_regions_35med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_35med_lowPT", "SS":"SR_SS35med_lowPT", "ncuts":6}
addon_regions_35med_lowPT[samples.top_antitruth]     = {"OS":"SR_35med_lowPT", "SS":"SR_SS35med_lowPT", "ncuts":6}
...
addon_regions_35med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_35med_highPT", "SS":"SR_SS35med_highPT", "ncuts":6}
addon_regions_35med_highPT[samples.top_antitruth]     = {"OS":"SR_35med_highPT", "SS":"SR_SS35med_highPT", "ncuts":6}
...
addon_regions_50L1TAU12med[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med", "SS":"SR_SS_50L1TAU12med", "ncuts":5}
addon_regions_50L1TAU12med[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med", "SS":"SR_SS_50L1TAU12med", "ncuts":5}
...
addon_regions_50L1TAU12med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_lowPT", "SS":"SR_SS50L1TAU12med_lowPT", "ncuts":6}
addon_regions_50L1TAU12med_lowPT[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_lowPT", "SS":"SR_SS50L1TAU12med_lowPT", "ncuts":6}
...
addon_regions_50L1TAU12med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_highPT", "SS":"SR_SS50L1TAU12med_highPT", "ncuts":6}
addon_regions_50L1TAU12med_highPT[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_highPT", "SS":"SR_SS50L1TAU12med_highPT", "ncuts":6}
...
addon_regions_80med[samples.Zttjets_antitruth]     = {"OS":"SR_80med", "SS":"SR_SS_80med", "ncuts":5}
addon_regions_80med[samples.top_antitruth]     = {"OS":"SR_80med", "SS":"SR_SS_80med", "ncuts":5}
...
addon_regions_80med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_80med_lowPT", "SS":"SR_SS80med_lowPT", "ncuts":6}
addon_regions_80med_lowPT[samples.top_antitruth]     = {"OS":"SR_80med_lowPT", "SS":"SR_SS80med_lowPT", "ncuts":6}
...
addon_regions_80med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_80med_highPT", "SS":"SR_SS80med_highPT", "ncuts":6}
addon_regions_80med_highPT[samples.top_antitruth]     = {"OS":"SR_80med_highPT", "SS":"SR_SS80med_highPT", "ncuts":6}
...
addon_regions_80L1TAU60med[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med", "SS":"SR_SS_80L1TAU60med", "ncuts":5}
addon_regions_80L1TAU60med[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med", "SS":"SR_SS_80L1TAU60med", "ncuts":5}
...
addon_regions_80L1TAU60med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_lowPT", "SS":"SR_SS80L1TAU60med_lowPT", "ncuts":6}
addon_regions_80L1TAU60med_lowPT[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_lowPT", "SS":"SR_SS80L1TAU60med_lowPT", "ncuts":6}
...
addon_regions_80L1TAU60med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_highPT", "SS":"SR_SS80L1TAU60med_highPT", "ncuts":6}
addon_regions_80L1TAU60med_highPT[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_highPT", "SS":"SR_SS80L1TAU60med_highPT", "ncuts":6}
...
addon_regions_125med[samples.Zttjets_antitruth]     = {"OS":"SR_125med", "SS":"SR_SS_125med", "ncuts":5}
addon_regions_125med[samples.top_antitruth]     = {"OS":"SR_125med", "SS":"SR_SS_125med", "ncuts":5}
...
addon_regions_125med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_125med_lowPT", "SS":"SR_SS125med_lowPT", "ncuts":6}
addon_regions_125med_lowPT[samples.top_antitruth]     = {"OS":"SR_125med_lowPT", "SS":"SR_SS125med_lowPT", "ncuts":6}
...
addon_regions_125med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_125med_highPT", "SS":"SR_SS125med_highPT", "ncuts":6}
addon_regions_125med_highPT[samples.top_antitruth]     = {"OS":"SR_125med_highPT", "SS":"SR_SS125med_highPT", "ncuts":6}
...
addon_regions_160med[samples.Zttjets_antitruth]     = {"OS":"SR_160med", "SS":"SR_SS_160med", "ncuts":5}
addon_regions_160med[samples.top_antitruth]     = {"OS":"SR_160med", "SS":"SR_SS_160med", "ncuts":5}
...
addon_regions_160med_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_160med_lowPT", "SS":"SR_SS160med_lowPT", "ncuts":6}
addon_regions_160med_lowPT[samples.top_antitruth]     = {"OS":"SR_160med_lowPT", "SS":"SR_SS160med_lowPT", "ncuts":6}
...
addon_regions_160med_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_160med_highPT", "SS":"SR_SS160med_highPT", "ncuts":6}
addon_regions_160med_highPT[samples.top_antitruth]     = {"OS":"SR_160med_highPT", "SS":"SR_SS160med_highPT", "ncuts":6}
...
addon_regions_L1TAU12IMmed[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed", "SS":"SR_SS_L1TAU12IMmed", "ncuts":5}
addon_regions_L1TAU12IMmed[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed", "SS":"SR_SS_L1TAU12IMmed", "ncuts":5}
...
addon_regions_L1TAU12IMmed_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_lowPT", "SS":"SR_SSL1TAU12IMmed_lowPT", "ncuts":6}
addon_regions_L1TAU12IMmed_lowPT[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_lowPT", "SS":"SR_SSL1TAU12IMmed_lowPT", "ncuts":6}
...
addon_regions_L1TAU12IMmed_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_highPT", "SS":"SR_SSL1TAU12IMmed_highPT", "ncuts":6}
addon_regions_L1TAU12IMmed_highPT[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_highPT", "SS":"SR_SSL1TAU12IMmed_highPT", "ncuts":6}
...
addon_regions_ptonly[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly", "SS":"SR_SS_ptonly", "ncuts":5}
addon_regions_ptonly[samples.top_antitruth]     = {"OS":"SR_ptonly", "SS":"SR_SS_ptonly", "ncuts":5}
...
addon_regions_ptonly_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_lowPT", "SS":"SR_SSptonly_lowPT", "ncuts":6}
addon_regions_ptonly_lowPT[samples.top_antitruth]     = {"OS":"SR_ptonly_lowPT", "SS":"SR_SSptonly_lowPT", "ncuts":6}
...
addon_regions_ptonly_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_highPT", "SS":"SR_SSptonly_highPT", "ncuts":6}
addon_regions_ptonly_highPT[samples.top_antitruth]     = {"OS":"SR_ptonly_highPT", "SS":"SR_SSptonly_highPT", "ncuts":6}
...
addon_regions_tracktwo[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo", "SS":"SR_SS_tracktwo", "ncuts":5}
addon_regions_tracktwo[samples.top_antitruth]     = {"OS":"SR_tracktwo", "SS":"SR_SS_tracktwo", "ncuts":5}
...
addon_regions_tracktwo_lowPT[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_lowPT", "SS":"SR_SStracktwo_lowPT", "ncuts":6}
addon_regions_tracktwo_lowPT[samples.top_antitruth]     = {"OS":"SR_tracktwo_lowPT", "SS":"SR_SStracktwo_lowPT", "ncuts":6}
...
addon_regions_tracktwo_highPT[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_highPT", "SS":"SR_SStracktwo_highPT", "ncuts":6}
addon_regions_tracktwo_highPT[samples.top_antitruth]     = {"OS":"SR_tracktwo_highPT", "SS":"SR_SStracktwo_highPT", "ncuts":6}
...
addon_regions_1Track[samples.top_antitruth]     = {"OS":"SR_Tau1Track", "SS":"SR_SS_Tau1Track", "ncuts":5}#{"OS":"SR_Tau1Track", "SS":"SR_SS_Tau1Track", "ncuts":5}
addon_regions_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_Tau1Track", "SS":"SR_SS_Tau1Track", "ncuts":5}#{"OS":"SR_Tau1Track", "SS":"SR_SS_Tau1Track", "ncuts":5}
...
#addon_regions_highPT_1Track[samples.Wjets]   = {"OS":"Wjets_OS_highPT_Tau1Track", "SS":"Wjets_SS_highPT_Tau1Track","ncuts":5}#{"OS":"SR_highPT_Tau1Track", "SS":"SR_SS_highPT_Tau1Track", "ncuts":6}
...
addon_regions_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_highPT_Tau1Track", "SS":"SR_SS_highPT_Tau1Track","ncuts":6}
addon_regions_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_highPT_Tau1Track", "SS":"SR_SS_highPT_Tau1Track","ncuts":6}
...
#addon_regions_lowPT_1Track[samples.Wjets]   = {"OS":"Wjets_OS_lowPT_Tau1Track", "SS":"Wjets_SS_lowPT_Tau1Track","ncuts":5}#{"OS":"SR_highPT_Tau1Track", "SS":"SR_SS_highPT_Tau1Track", "ncuts":6}
...
addon_regions_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_lowPT_Tau1Track", "SS":"SR_SS_lowPT_Tau1Track", "ncuts":6}
addon_regions_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_lowPT_Tau1Track", "SS":"SR_SS_lowPT_Tau1Track", "ncuts":6}
...
addon_regions_25med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_25med_Tau1Track", "SS":"SR_SS25med_Tau1Track","ncuts":6}
addon_regions_25med_1Track[samples.top_antitruth]     = {"OS":"SR_25med_Tau1Track", "SS":"SR_SS25med_Tau1Track","ncuts":6}
...
addon_regions_25med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_25med_lowPT_Tau1Track", "SS":"SR_SS25med_lowPT_Tau1Track", "ncuts":7}
addon_regions_25med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_25med_lowPT_Tau1Track", "SS":"SR_SS25med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_25med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_25med_highPT_Tau1Track", "SS":"SR_SS25med_highPT_Tau1Track", "ncuts":7}
addon_regions_25med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_25med_highPT_Tau1Track", "SS":"SR_SS25med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_35med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_35med_Tau1Track", "SS":"SR_SS35med_Tau1Track", "ncuts":6}
addon_regions_35med_1Track[samples.top_antitruth]     = {"OS":"SR_35med_Tau1Track", "SS":"SR_SS35med_Tau1Track", "ncuts":6}
...
addon_regions_35med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_35med_lowPT_Tau1Track", "SS":"SR_SS35med_lowPT_Tau1Track", "ncuts":7}
addon_regions_35med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_35med_lowPT_Tau1Track", "SS":"SR_SS35med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_35med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_35med_highPT_Tau1Track", "SS":"SR_SS35med_highPT_Tau1Track", "ncuts":7}
addon_regions_35med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_35med_highPT_Tau1Track", "SS":"SR_SS35med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_50L1TAU12med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_Tau1Track", "SS":"SR_SS50L1TAU12med_Tau1Track", "ncuts":6}
addon_regions_50L1TAU12med_1Track[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_Tau1Track", "SS":"SR_SS50L1TAU12med_Tau1Track", "ncuts":6}
...
addon_regions_50L1TAU12med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_lowPT_Tau1Track", "SS":"SR_SS50L1TAU12med_lowPT_Tau1Track", "ncuts":7}
addon_regions_50L1TAU12med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_lowPT_Tau1Track", "SS":"SR_SS50L1TAU12med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_50L1TAU12med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_highPT_Tau1Track", "SS":"SR_SS50L1TAU12med_highPT_Tau1Track", "ncuts":7}
addon_regions_50L1TAU12med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_highPT_Tau1Track", "SS":"SR_SS50L1TAU12med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_80med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_80med_Tau1Track", "SS":"SR_SS80med_Tau1Track", "ncuts":6}
addon_regions_80med_1Track[samples.top_antitruth]     = {"OS":"SR_80med_Tau1Track", "SS":"SR_SS80med_Tau1Track", "ncuts":6}
...
addon_regions_80med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_80med_lowPT_Tau1Track", "SS":"SR_SS80med_lowPT_Tau1Track", "ncuts":7}
addon_regions_80med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_80med_lowPT_Tau1Track", "SS":"SR_SS80med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_80med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_80med_highPT_Tau1Track", "SS":"SR_SS80med_highPT_Tau1Track", "ncuts":7}
addon_regions_80med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_80med_highPT_Tau1Track", "SS":"SR_SS80med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_80L1TAU60med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_Tau1Track", "SS":"SR_SS80L1TAU60med_Tau1Track", "ncuts":6}
addon_regions_80L1TAU60med_1Track[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_Tau1Track", "SS":"SR_SS80L1TAU60med_Tau1Track", "ncuts":6}
...
addon_regions_80L1TAU60med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_lowPT_Tau1Track", "SS":"SR_SS80L1TAU60med_lowPT_Tau1Track", "ncuts":7}
addon_regions_80L1TAU60med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_lowPT_Tau1Track", "SS":"SR_SS80L1TAU60med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_80L1TAU60med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_highPT_Tau1Track", "SS":"SR_SS80L1TAU60med_highPT_Tau1Track", "ncuts":7}
addon_regions_80L1TAU60med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_highPT_Tau1Track", "SS":"SR_SS80L1TAU60med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_125med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_125med_Tau1Track", "SS":"SR_SS125med_Tau1Track", "ncuts":6}
addon_regions_125med_1Track[samples.top_antitruth]     = {"OS":"SR_125med_Tau1Track", "SS":"SR_SS125med_Tau1Track", "ncuts":6}
...
addon_regions_125med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_125med_lowPT_Tau1Track", "SS":"SR_SS125med_lowPT_Tau1Track", "ncuts":7}
addon_regions_125med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_125med_lowPT_Tau1Track", "SS":"SR_SS125med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_125med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_125med_highPT_Tau1Track", "SS":"SR_SS125med_highPT_Tau1Track", "ncuts":7}
addon_regions_125med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_125med_highPT_Tau1Track", "SS":"SR_SS125med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_160med_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_160med_Tau1Track", "SS":"SR_SS160med_Tau1Track", "ncuts":6}
addon_regions_160med_1Track[samples.top_antitruth]     = {"OS":"SR_160med_Tau1Track", "SS":"SR_SS160med_Tau1Track", "ncuts":6}
...
addon_regions_160med_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_160med_lowPT_Tau1Track", "SS":"SR_SS160med_lowPT_Tau1Track", "ncuts":7}
addon_regions_160med_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_160med_lowPT_Tau1Track", "SS":"SR_SS160med_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_160med_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_160med_highPT_Tau1Track", "SS":"SR_SS160med_highPT_Tau1Track", "ncuts":7}
addon_regions_160med_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_160med_highPT_Tau1Track", "SS":"SR_SS160med_highPT_Tau1Track", "ncuts":7}
...
addon_regions_L1TAU12IMmed_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_Tau1Track", "SS":"SR_SSL1TAU12IMmed_Tau1Track", "ncuts":6}
addon_regions_L1TAU12IMmed_1Track[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_Tau1Track", "SS":"SR_SSL1TAU12IMmed_Tau1Track", "ncuts":6}
...
addon_regions_L1TAU12IMmed_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_lowPT_Tau1Track", "SS":"SR_SSL1TAU12IMmed_lowPT_Tau1Track", "ncuts":7}
addon_regions_L1TAU12IMmed_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_lowPT_Tau1Track", "SS":"SR_SSL1TAU12IMmed_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_L1TAU12IMmed_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_highPT_Tau1Track", "SS":"SR_SSL1TAU12IMmed_highPT_Tau1Track", "ncuts":7}
addon_regions_L1TAU12IMmed_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_highPT_Tau1Track", "SS":"SR_SSL1TAU12IMmed_highPT_Tau1Track", "ncuts":7}
...
addon_regions_ptonly_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_Tau1Track", "SS":"SR_SSptonly_Tau1Track", "ncuts":6}
addon_regions_ptonly_1Track[samples.top_antitruth]     = {"OS":"SR_ptonly_Tau1Track", "SS":"SR_SSptonly_Tau1Track", "ncuts":6}
...
addon_regions_ptonly_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_lowPT_Tau1Track", "SS":"SR_SSptonly_lowPT_Tau1Track", "ncuts":7}
addon_regions_ptonly_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_ptonly_lowPT_Tau1Track", "SS":"SR_SSptonly_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_ptonly_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_highPT_Tau1Track", "SS":"SR_SSptonly_highPT_Tau1Track", "ncuts":7}
addon_regions_ptonly_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_ptonly_highPT_Tau1Track", "SS":"SR_SSptonly_highPT_Tau1Track", "ncuts":7}
...
addon_regions_tracktwo_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_Tau1Track", "SS":"SR_SStracktwo_Tau1Track", "ncuts":6}
addon_regions_tracktwo_1Track[samples.top_antitruth]     = {"OS":"SR_tracktwo_Tau1Track", "SS":"SR_SStracktwo_Tau1Track", "ncuts":6}
...
addon_regions_tracktwo_lowPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_lowPT_Tau1Track", "SS":"SR_SStracktwo_lowPT_Tau1Track", "ncuts":7}
addon_regions_tracktwo_lowPT_1Track[samples.top_antitruth]     = {"OS":"SR_tracktwo_lowPT_Tau1Track", "SS":"SR_SStracktwo_lowPT_Tau1Track", "ncuts":7}
...
addon_regions_tracktwo_highPT_1Track[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_highPT_Tau1Track", "SS":"SR_SStracktwo_highPT_Tau1Track", "ncuts":7}
addon_regions_tracktwo_highPT_1Track[samples.top_antitruth]     = {"OS":"SR_tracktwo_highPT_Tau1Track", "SS":"SR_SStracktwo_highPT_Tau1Track", "ncuts":7}
...
addon_regions_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_Tau3Track", "SS":"SR_SS_Tau3Track", "ncuts":5}
addon_regions_3Track[samples.top_antitruth]     = {"OS":"SR_Tau3Track", "SS":"SR_SS_Tau3Track", "ncuts":5}
...
#addon_regions_highPT_3Track[samples.Wjets]   = {"OS":"Wjets_OS_highPT_Tau3Track", "SS":"Wjets_SS_highPT_Tau3Track","ncuts":5}#{"OS":"SR_highPT_Tau1Track", "SS":"SR_SS_highPT_Tau1Track", "ncuts":6}
addon_regions_highPT_3Track[samples.Zlljets] = {"OS":"SR_highPT_Tau3Track", "SS":"SR_SS_highPT_Tau3Track", "ncuts":6}
addon_regions_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_highPT_Tau3Track", "SS":"SR_SS_highPT_Tau3Track", "ncuts":6}
addon_regions_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_highPT_Tau3Track", "SS":"SR_SS_highPT_Tau3Track", "ncuts":6}
...
#addon_regions_lowPT_3Track[samples.Wjets]   = {"OS":"Wjets_OS_lowPT_Tau3Track", "SS":"Wjets_SS_lowPT_Tau3Track","ncuts":5}#{"OS":"SR_highPT_Tau1Track", "SS":"SR_SS_highPT_Tau1Track", "ncuts":6}
addon_regions_lowPT_3Track[samples.Zlljets] = {"OS":"SR_lowPT_Tau3Track", "SS":"SR_SS_lowPT_Tau3Track", "ncuts":6}
addon_regions_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_lowPT_Tau3Track", "SS":"SR_SS_lowPT_Tau3Track", "ncuts":6}
addon_regions_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_lowPT_Tau3Track", "SS":"SR_SS_lowPT_Tau3Track", "ncuts":6}
...
addon_regions_25med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_25med_Tau3Track", "SS":"SR_SS25med_Tau3Track", "ncuts":6}
addon_regions_25med_3Track[samples.top_antitruth]     = {"OS":"SR_25med_Tau3Track", "SS":"SR_SS25med_Tau3Track", "ncuts":6}
...
addon_regions_25med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_25med_lowPT_Tau3Track", "SS":"SR_SS25med_lowPT_Tau3Track", "ncuts":7}
addon_regions_25med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_25med_lowPT_Tau3Track", "SS":"SR_SS25med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_25med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_25med_highPT_Tau3Track", "SS":"SR_SS25med_highPT_Tau3Track", "ncuts":7}
addon_regions_25med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_25med_highPT_Tau3Track", "SS":"SR_SS25med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_35med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_35med_Tau3Track", "SS":"SR_SS35med_Tau3Track", "ncuts":6}
addon_regions_35med_3Track[samples.top_antitruth]     = {"OS":"SR_35med_Tau3Track", "SS":"SR_SS35med_Tau3Track", "ncuts":6}
...
addon_regions_35med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_35med_lowPT_Tau3Track", "SS":"SR_SS35med_lowPT_Tau3Track", "ncuts":7}
addon_regions_35med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_35med_lowPT_Tau3Track", "SS":"SR_SS35med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_35med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_35med_highPT_Tau3Track", "SS":"SR_SS35med_highPT_Tau3Track", "ncuts":7}
addon_regions_35med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_35med_highPT_Tau3Track", "SS":"SR_SS35med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_50L1TAU12med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_Tau3Track", "SS":"SR_SS50L1TAU12med_Tau3Track", "ncuts":6}
addon_regions_50L1TAU12med_3Track[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_Tau3Track", "SS":"SR_SS50L1TAU12med_Tau3Track", "ncuts":6}
...
addon_regions_50L1TAU12med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_lowPT_Tau3Track", "SS":"SR_SS50L1TAU12med_lowPT_Tau3Track", "ncuts":7}
addon_regions_50L1TAU12med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_lowPT_Tau3Track", "SS":"SR_SS50L1TAU12med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_50L1TAU12med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_50L1TAU12med_highPT_Tau3Track", "SS":"SR_SS50L1TAU12med_highPT_Tau3Track", "ncuts":7}
addon_regions_50L1TAU12med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_50L1TAU12med_highPT_Tau3Track", "SS":"SR_SS50L1TAU12med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_80med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_80med_Tau3Track", "SS":"SR_SS80med_Tau3Track", "ncuts":6}
addon_regions_80med_3Track[samples.top_antitruth]     = {"OS":"SR_80med_Tau3Track", "SS":"SR_SS80med_Tau3Track", "ncuts":6}
...
addon_regions_80med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_80med_lowPT_Tau3Track", "SS":"SR_SS80med_lowPT_Tau3Track", "ncuts":7}
addon_regions_80med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_80med_lowPT_Tau3Track", "SS":"SR_SS80med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_80med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_80med_highPT_Tau3Track", "SS":"SR_SS80med_highPT_Tau3Track", "ncuts":7}
addon_regions_80med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_80med_highPT_Tau3Track", "SS":"SR_SS80med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_80L1TAU60med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_Tau3Track", "SS":"SR_SS80L1TAU60med_Tau3Track", "ncuts":6}
addon_regions_80L1TAU60med_3Track[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_Tau3Track", "SS":"SR_SS80L1TAU60med_Tau3Track", "ncuts":6}
...
addon_regions_80L1TAU60med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_lowPT_Tau3Track", "SS":"SR_SS80L1TAU60med_lowPT_Tau3Track", "ncuts":7}
addon_regions_80L1TAU60med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_lowPT_Tau3Track", "SS":"SR_SS80L1TAU60med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_80L1TAU60med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_80L1TAU60med_highPT_Tau3Track", "SS":"SR_SS80L1TAU60med_highPT_Tau3Track", "ncuts":7}
addon_regions_80L1TAU60med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_80L1TAU60med_highPT_Tau3Track", "SS":"SR_SS80L1TAU60med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_125med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_125med_Tau3Track", "SS":"SR_SS125med_Tau3Track", "ncuts":6}
addon_regions_125med_3Track[samples.top_antitruth]     = {"OS":"SR_125med_Tau3Track", "SS":"SR_SS125med_Tau3Track", "ncuts":6}
...
addon_regions_125med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_125med_lowPT_Tau3Track", "SS":"SR_SS125med_lowPT_Tau3Track", "ncuts":7}
addon_regions_125med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_125med_lowPT_Tau3Track", "SS":"SR_SS125med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_125med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_125med_highPT_Tau3Track", "SS":"SR_SS125med_highPT_Tau3Track", "ncuts":7}
addon_regions_125med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_125med_highPT_Tau3Track", "SS":"SR_SS125med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_160med_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_160med_Tau3Track", "SS":"SR_SS160med_Tau3Track", "ncuts":6}
addon_regions_160med_3Track[samples.top_antitruth]     = {"OS":"SR_160med_Tau3Track", "SS":"SR_SS160med_Tau3Track", "ncuts":6}
...
addon_regions_160med_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_160med_lowPT_Tau3Track", "SS":"SR_SS160med_lowPT_Tau3Track", "ncuts":7}
addon_regions_160med_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_160med_lowPT_Tau3Track", "SS":"SR_SS160med_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_160med_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_160med_highPT_Tau3Track", "SS":"SR_SS160med_highPT_Tau3Track", "ncuts":7}
addon_regions_160med_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_160med_highPT_Tau3Track", "SS":"SR_SS160med_highPT_Tau3Track", "ncuts":7}
...
addon_regions_L1TAU12IMmed_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_Tau3Track", "SS":"SR_SSL1TAU12IMmed_Tau3Track", "ncuts":6}
addon_regions_L1TAU12IMmed_3Track[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_Tau3Track", "SS":"SR_SSL1TAU12IMmed_Tau3Track", "ncuts":6}
...
addon_regions_L1TAU12IMmed_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_lowPT_Tau3Track", "SS":"SR_SSL1TAU12IMmed_lowPT_Tau3Track", "ncuts":7}
addon_regions_L1TAU12IMmed_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_lowPT_Tau3Track", "SS":"SR_SSL1TAU12IMmed_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_L1TAU12IMmed_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_L1TAU12IMmed_highPT_Tau3Track", "SS":"SR_SSL1TAU12IMmed_highPT_Tau3Track", "ncuts":7}
addon_regions_L1TAU12IMmed_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_L1TAU12IMmed_highPT_Tau3Track", "SS":"SR_SSL1TAU12IMmed_highPT_Tau3Track", "ncuts":7}
...
addon_regions_ptonly_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_Tau3Track", "SS":"SR_SSptonly_Tau3Track", "ncuts":6}
addon_regions_ptonly_3Track[samples.top_antitruth]     = {"OS":"SR_ptonly_Tau3Track", "SS":"SR_SSptonly_Tau3Track", "ncuts":6}
...
addon_regions_ptonly_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_lowPT_Tau3Track", "SS":"SR_SSptonly_lowPT_Tau3Track", "ncuts":7}
addon_regions_ptonly_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_ptonly_lowPT_Tau3Track", "SS":"SR_SSptonly_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_ptonly_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_ptonly_highPT_Tau3Track", "SS":"SR_SSptonly_highPT_Tau3Track", "ncuts":7}
addon_regions_ptonly_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_ptonly_highPT_Tau3Track", "SS":"SR_SSptonly_highPT_Tau3Track", "ncuts":7}
...
addon_regions_tracktwo_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_Tau3Track", "SS":"SR_SStracktwo_Tau3Track", "ncuts":6}
addon_regions_tracktwo_3Track[samples.top_antitruth]     = {"OS":"SR_tracktwo_Tau3Track", "SS":"SR_SStracktwo_Tau3Track", "ncuts":6}
...
addon_regions_tracktwo_lowPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_lowPT_Tau3Track", "SS":"SR_SStracktwo_lowPT_Tau3Track", "ncuts":7}
addon_regions_tracktwo_lowPT_3Track[samples.top_antitruth]     = {"OS":"SR_tracktwo_lowPT_Tau3Track", "SS":"SR_SStracktwo_lowPT_Tau3Track", "ncuts":7}
...
addon_regions_tracktwo_highPT_3Track[samples.Zttjets_antitruth]     = {"OS":"SR_tracktwo_highPT_Tau3Track", "SS":"SR_SStracktwo_highPT_Tau3Track", "ncuts":7}
addon_regions_tracktwo_highPT_3Track[samples.top_antitruth]     = {"OS":"SR_tracktwo_highPT_Tau3Track", "SS":"SR_SStracktwo_highPT_Tau3Track", "ncuts":7}
...
hm = hm,
sample = m,
samples = [addon_Zlljets, addon_Zttjets_antitruth, addon_top_antitruth, addon_Wjets, addon_data]
)

m = fakes_background_25med
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_Zlljets_25med, addon_Zttjets_antitruth_25med, addon_top_antitruth_25med, addon_Wjets_25med, addon_data_25med]
)
m = fakes_background_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_Zlljets_1Track, addon_Zttjets_antitruth_1Track, addon_top_antitruth_1Track, addon_Wjets_1Track, addon_data_1Track]
)
m = fakes_background_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_Zlljets_3Track, addon_Zttjets_antitruth_3Track, addon_top_antitruth_3Track, addon_Wjets_3Track, addon_data_3Track]
)
m = fakes_background_25med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_Zlljets_25med_1Track, addon_Zttjets_antitruth_25med_1Track, addon_top_antitruth_25med_1Track, addon_Wjets_25med_1Track, addon_data_25med_1Track]
)
m = fakes_background_25med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
...
hm = hm,
sample = m,
samples = [samples.Zttjets_truth ,samples.top_truth]
)

#Merge antitruth top  with antitruth ztts
...
hm = hm,
sample = m,
samples = [addon_top_antitruth,addon_Zttjets_antitruth]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_25med,addon_Zttjets_antitruth_25med]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_35med,addon_Zttjets_antitruth_35med]
)

m = addon_top_50L1TAU12med
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_50L1TAU12med,addon_Zttjets_antitruth_50L1TAU12med]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_80med,addon_Zttjets_antitruth_80med]
)

m = addon_top_80L1TAU60med
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_80L1TAU60med,addon_Zttjets_antitruth_80L1TAU60med]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_125med,addon_Zttjets_antitruth_125med]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_160med,addon_Zttjets_antitruth_160med]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_ptonly,addon_Zttjets_antitruth_ptonly]
)

m = addon_top_tracktwo
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_tracktwo,addon_Zttjets_antitruth_tracktwo]
)

m = addon_top_L1TAU12IMmed
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_L1TAU12IMmed,addon_Zttjets_antitruth_L1TAU12IMmed]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_1Track,addon_Zttjets_antitruth_1Track]
)

m = addon_top_25med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_25med_1Track,addon_Zttjets_antitruth_25med_1Track]
)

m = addon_top_35med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_35med_1Track,addon_Zttjets_antitruth_35med_1Track]
)

m = addon_top_50L1TAU12med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_50L1TAU12med_1Track,addon_Zttjets_antitruth_50L1TAU12med_1Track]
)

m = addon_top_80med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_80med_1Track,addon_Zttjets_antitruth_80med_1Track]
)

m = addon_top_80L1TAU60med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_80L1TAU60med_1Track,addon_Zttjets_antitruth_80L1TAU60med_1Track]
)

m = addon_top_125med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_125med_1Track,addon_Zttjets_antitruth_125med_1Track]
)

m = addon_top_160med_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_160med_1Track,addon_Zttjets_antitruth_160med_1Track]
)

m = addon_top_ptonly_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_ptonly_1Track,addon_Zttjets_antitruth_ptonly_1Track]
)

m = addon_top_tracktwo_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_tracktwo_1Track,addon_Zttjets_antitruth_tracktwo_1Track]
)

m = addon_top_L1TAU12IMmed_1Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_L1TAU12IMmed_1Track,addon_Zttjets_antitruth_L1TAU12IMmed_1Track]
)
...
hm = hm,
sample = m,
samples = [addon_top_antitruth_3Track,addon_Zttjets_antitruth_3Track]
)

m = addon_top_25med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_25med_3Track,addon_Zttjets_antitruth_25med_3Track]
)

m = addon_top_35med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_35med_3Track,addon_Zttjets_antitruth_35med_3Track]
)

m = addon_top_50L1TAU12med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_50L1TAU12med_3Track,addon_Zttjets_antitruth_50L1TAU12med_3Track]
)

m = addon_top_80med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_80med_3Track,addon_Zttjets_antitruth_80med_3Track]
)

m = addon_top_80L1TAU60med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_80L1TAU60med_3Track,addon_Zttjets_antitruth_80L1TAU60med_3Track]
)

m = addon_top_125med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_125med_3Track,addon_Zttjets_antitruth_125med_3Track]
)

m = addon_top_160med_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_160med_3Track,addon_Zttjets_antitruth_160med_3Track]
)

m = addon_top_ptonly_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_ptonly_3Track,addon_Zttjets_antitruth_ptonly_3Track]
)

m = addon_top_tracktwo_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_tracktwo_3Track,addon_Zttjets_antitruth_tracktwo_3Track]
)

m = addon_top_L1TAU12IMmed_3Track
m.estimator = histmgr.MergeEstimator(
hm = hm,
sample = m,
samples = [addon_top_antitruth_L1TAU12IMmed_3Track,addon_Zttjets_antitruth_L1TAU12IMmed_3Track]
)
...
#-----------------
#mc_truth_signals = []
#mc_truth_signals.append(truth_taus)
...
if "SR" == options.region:
	...
	print "signal region"
	#plot_backgrounds.append(fakes_background)
	...
	#plot_backgrounds.append(fakes_background_1Track)
	...
	#plot_backgrounds.append(fakes_background_25med_1Track)
...
elif "SR_lowSCDP_Tau1Track" == options.region:

	plot_signals.append(samples.Zttjets)
	#plot_backgrounds.append(addon_data_lowSCDP)
        plot_backgrounds.append(addon_Wjets_lowSCDP_1Track)
        plot_backgrounds.append(addon_Zlljets_lowSCDP_1Track)
        plot_backgrounds.append(addon_top_lowSCDP_1Track)

elif "SR_lowSCDP_Tau3Track" == options.region:

	plot_signals.append(samples.Zttjets)
	#plot_backgrounds.append(addon_data_lowSCDP)
        plot_backgrounds.append(addon_Wjets_lowSCDP_3Track)
        plot_backgrounds.append(addon_Zlljets_lowSCDP_3Track)
        plot_backgrounds.append(addon_top_lowSCDP_3Track)

elif "SR_lowSCDP" == options.region:
        """
	plot_signals.append(samples.Zttjets_truth)
	plot_signals.append(samples.top_truth)
	#plot_backgrounds.append(addon_data_lowSCDP)
        plot_backgrounds.append(addon_Wjets_lowSCDP)
        plot_backgrounds.append(addon_Zlljets_lowSCDP)
        plot_backgrounds.append(addon_top_antitruth_lowSCDP)
        plot_backgrounds.append(addon_top_truth_lowSCDP)
	"""
        plot_backgrounds.append(samples.Wjets)
        plot_backgrounds.append(samples.Zlljets)
        plot_backgrounds.append(samples.top_antitruth)
        plot_backgrounds.append(samples.Zttjets_antitruth)
...
elif "Wjets_OS_Tau1Track" == options.region:
...
elif "AntiIsoCR_OS_Tau3Track" == options.region:
...
#	print "signal region"
	...
	#plot_backgrounds.append(fakes_background_25med)
...
if options.makeplot == "True":
 funcs.plot_hist(
    ...
    do_ratio_plot = True,
    tprofile      = vdict[options.vname]['tprofile'],
    plotsfile     = plotsfile,
