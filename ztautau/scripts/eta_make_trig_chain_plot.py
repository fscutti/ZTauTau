...
f = ROOT.TFile('./eta_trigger_chain_effiencies.root')
...
tlatex.DrawLatex(0.2,0.07,'#bf{#it{ATLAS}} Internal, 33.3 fb^{-1}, #sqrt{s} = 13 TeV')
...
pad1.cd()
fr1 = pad1.DrawFrame(0,0,300,1,';%s;Data/exp.'%('#eta'))
...
xaxis_bot1.SetRangeUser(-3,3)
yaxis_bot1.SetRangeUser(0,1.02)
yaxis_bot1.SetRangeUser(0,1.02)
#xaxis_bot1.SetTitle('#eta')
...
pad2.cd()
fr2 = pad2.DrawFrame(0,0.8,300,1.2,';%s;Data/exp.'%('#eta'))
...
xaxis_bot2.SetRangeUser(-3,3)
yaxis_bot2.SetRangeUser(0.86,1.02)
#xaxis_bot2.SetTitle('#eta')
...
pad3.cd()
fr3 = pad3.DrawFrame(0,0.8,300,1.2,';%s;Data/exp.'%('#eta'))
...
xaxis_bot3.SetRangeUser(-3,3)
yaxis_bot3.SetRangeUser(0.86,1.02)
#xaxis_bot3.SetTitle('#eta')
...
pad4.cd()
fr4 = pad4.DrawFrame(0,0.8,300,1.2,';%s;Data/exp.'%('#eta'))
...
xaxis_bot4.SetRangeUser(-3,3)
yaxis_bot4.SetRangeUser(0.9,1.02)
xaxis_bot4.SetTitle('#eta')
...
pad5.cd()
fr5 = pad5.DrawFrame(0,0,300,1,';%s;Data/exp.'%('#eta'))
...
xaxis_bot5.SetRangeUser(-3,3)
#yaxis_bot5.SetRangeUser(0,1.02)
#xaxis_bot5.SetTitle('#eta')
...
pad6.cd()
fr6 = pad6.DrawFrame(0,0.8,300,1.2,';%s;Data/exp.'%('#eta'))
...
xaxis_bot6.SetRangeUser(-3,3)
yaxis_bot6.SetRangeUser(0.86,1.02)
#xaxis_bot6.SetTitle('#eta')
...
pad7.cd()
fr7 = pad7.DrawFrame(0,0.8,300,1.2,';%s;Data/exp.'%('#eta'))
...
xaxis_bot7.SetRangeUser(-3,3)
yaxis_bot7.SetRangeUser(0.86,1.02)
#xaxis_bot7.SetTitle('#eta')
...
pad8.cd()
fr8 = pad8.DrawFrame(0,0.8,300,1.2,';%s;Data/exp.'%('#eta'))
...
xaxis_bot8.SetRangeUser(-3,3)
yaxis_bot8.SetRangeUser(0.9,1.02)
xaxis_bot8.SetTitle('#eta')
...
g = ROOT.TFile('./eta_multipadeffs.root', 'recreate')
c.Write()
g.Close()
c.Draw()
