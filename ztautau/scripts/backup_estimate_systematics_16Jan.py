...
f = ROOT.TFile('../../test/Hists_systematics/BDT_tight/'+str(trig)+'/hists_'+str(variable)+'_SR_Tau'+str(trax)+'.root')
hist_SR_subztt_pretrig1 = f.Get('h_SR_Tau'+str(trax)+'_nominal_data')

g = ROOT.TFile('../../test/Hists_systematics/BDT_tight/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(trig)+'_Tau'+str(trax)+'.root')
hist_SR_subztt_posttrig1 = g.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_nominal_data')

if trig and chain:
	print "TRIGGER PERFORMANCE STUDY:"
	g_chain = ROOT.TFile('../../test/Hists_systematics/BDT_tight/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(chain)+'_Tau'+str(trax)+'.root')
        hist_SR_subztt_posttrig1_chain = g_chain.Get('h_SR_'+str(chain)+'_Tau'+str(trax)+'_nominal_data_'+str(chain)+'_'+str(trax))

h = ROOT.TFile('../../test/Hists_systematics/BDT_tight/'+str(trig)+'/hists_'+str(variable)+'_SR_Tau'+str(trax)+'.root')
hist_SR_MC_pretrig1 = h.Get('h_SR_Tau'+str(trax)+'_nominal_truth_taus')

i = ROOT.TFile('../../test/Hists_systematics/BDT_tight/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(trig)+'_Tau'+str(trax)+'.root')
hist_SR_MC_posttrig1 = i.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_nominal_truth_taus')

if trig and chain:
	i_chain = ROOT.TFile('../../test/Hists_systematics/BDT_tight/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(chain)+'_Tau'+str(trax)+'.root')
...
for i in range(len(sys_dn)):
	...
	if sys_dn[i] == 'pretrig_fw_lowPT_Tau'+str(trax)+'_DN':
		...
		g0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(trig)+'_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
		    sys_dn_hist_SR_subztt_posttrig1 = g0.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_fw_lowPT_'+str(trax)+'_25med_DN_data')
                else:
		...
		f0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
		    sys_dn_hist_SR_subztt_pretrig1 = f0.Get('h_SR_Tau'+str(trax)+'_nominal_data')
                else:
                    sys_dn_hist_SR_subztt_pretrig1 = f0.Get('h_SR_Tau'+str(trax)+'_nominal_sub_ztt_'+str(trax))

		g0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(trig)+'_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
                    sys_dn_hist_SR_subztt_posttrig1 = g0.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_fw_highPT_'+str(trax)+'_25med_DN_data')
                else:
		...
		f0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
                    sys_dn_hist_SR_subztt_pretrig1 = f0.Get('h_SR_Tau'+str(trax)+'_kW_OS_lowPT_Tau'+str(trax)+'_DN_data')
                else:
                    sys_dn_hist_SR_subztt_pretrig1 = f0.Get('h_SR_Tau'+str(trax)+'_kW_OS_lowPT_Tau'+str(trax)+'_DN_sub_ztt_'+str(trax))

		g0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(trig)+'_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
                    sys_dn_hist_SR_subztt_posttrig1 = g0.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_nominal_data')
                else:
                    sys_dn_hist_SR_subztt_posttrig1 = g0.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_nominal_sub_ztt_'+str(trig)+'_'+str(trax))
		...
		f0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
                    sys_dn_hist_SR_subztt_pretrig1 = f0.Get('h_SR_Tau'+str(trax)+'_kW_OS_highPT_Tau'+str(trax)+'_DN_data')
                else:
		...
		g0 = ROOT.TFile('../../test/Hists_systematics/BDT_'+str(bdt)+'/'+str(trig)+'/hists_'+str(variable)+'_SR_'+str(trig)+'_Tau'+str(trax)+'.root')
                if str(bdt) == "tight" and str(trax) == "3Track":
                    sys_dn_hist_SR_subztt_posttrig1 = g0.Get('h_SR_'+str(trig)+'_Tau'+str(trax)+'_kW_OS_25med_lowPT_Tau'+str(trax)+'_DN_data')
                else:
	...
	#nom_file = ROOT.TFile('simple_outputnew.root')
        nom_file_medium_bdt = ROOT.TFile('simple_outputnew_medium_bdt.root')
        #nom_file_medium_bdt.Print()
        g_efficiency_simple_subztt_nominal = nom_file_medium_bdt.Get('data_medium'+str(trax)+str(trig))

        g_efficiency_simple_subztt_nominal.Print("all")
...
for i in range(len(sys_up)):
	...
	nom_file = ROOT.TFile('simple_outputnew.root')
        ...
        #nom_file_medium_bdt.Print()
        g_efficiency_simple_subztt_nominal = nom_file_medium_bdt.Get('data_medium'+str(trax)+str(trig))
	#g_efficiency_simple_subztt_nominal = nom_file.Get('data_medium')
...
save_h_efficiency.SetName("nominal_eff_data_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")

save_h_ratio = h_ratio.Clone()
save_h_ratio.SetName("SF_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")

save_stats_mc_up = total_stat_up_mc.Clone()
save_stats_mc_dn = total_stat_dn_mc.Clone()
save_stats_mc_up.SetName("stats_mc_up_eff_mc_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")
save_stats_mc_dn.SetName("stats_mc_dn_eff_mc_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")

save_stats_data_up = total_stat_up_data.Clone()
save_stats_data_dn = total_stat_dn_data.Clone()
save_stats_data_up.SetName("stats_data_up_eff_data_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")
save_stats_data_dn.SetName("stats_data_dn_eff_data_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")

save_sys_data_up = total_sys_up_data.Clone()
save_sys_data_dn = total_sys_dn_data.Clone()
save_sys_data_up.SetName("sys_data_up_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")
save_sys_data_dn.SetName("sys_data_dn_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")

save_tot_up = total_err_up_ratio.Clone()
save_tot_dn = total_err_dn_ratio.Clone()
save_tot_up.SetName("tot_up_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")
save_tot_dn.SetName("tot_dn_"+str(variable)+"_"+str(trig)+"_"+str(trax)+"_BDT_tight")
...
c = ROOT.TCanvas(str(variable)+"_"+str(trax)+"_"+str(trig)+"_tight_efficiency",str(variable)+"_"+str(trax)+"efficiency",600,600)
...
if trax:
	if str(trax) == '1Track':
		if str(bdt) == "medium":
			...
			tlatex.DrawLatex(0.45,0.36,'1-prong, BDT tight')
	elif str(trax) == '3Track':
		if str(bdt) == "medium":
			tlatex.DrawLatex(0.45,0.36,'3-prong')
		else:
			tlatex.DrawLatex(0.45,0.36,'3-prong, BDT tight')
...
pad2.RedrawAxis()
if trax:
	plotsfile = os.path.join("./","eff_"+str(variable)+"_"+str(trax)+"_"+str(trig)+"_tight_SYS.root")
else:
...
if trig and chain:
	...
	#ratio_plot.Print("all")
        ...
        if str(variable) == "tau_pt":
            for k in range(0,h_ratio_chain.GetNbinsX()+1):
                up_unc = math.sqrt(total_stat_up_data.GetBinContent(k)**2 + total_stat_up_data_chain.GetBinContent(k)**2)
                print k, h_ratio_chain.GetBinContent(k), up_unc
                if h_ratio_chain.GetBinContent(k) > 1:
                        h_ratio_chain.SetBinContent(k,1)
                        total_stat_up_data.SetBinContent(k,0)
                        total_stat_up_data_chain.SetBinContent(k,0)
                elif h_ratio_chain.GetBinContent(k) + math.sqrt(total_stat_up_data.GetBinContent(k)**2 + total_stat_up_data_chain.GetBinContent(k)**2) > 1:
                        print "going over", k, h_ratio_chain.GetBinContent(k),math.sqrt(total_stat_up_data.GetBinContent(k)**2 + total_stat_up_data_chain.GetBinContent(k)**2)
                        total_stat_up_data.SetBinContent(k,0)
	...
	if trax:
		if str(trax) == '1Track':
			if str(bdt) == "medium":
				...
				tlatex.DrawLatex(0.45,0.41,'Z#rightarrow#tau_{#mu}#tau_{had} T&P, 1-prong, BDT tight')
		elif str(trax) == '3Track':
			if str(bdt) == "medium":
				tlatex.DrawLatex(0.45,0.41,'Z#rightarrow#tau_{#mu}#tau_{had} T&P, 3-prong')
			else:
				tlatex.DrawLatex(0.45,0.41,'Z#rightarrow#tau_{#mu}#tau_{had} T&P, 3-prong, BDT tight')
	...
	if trax:
		if str(trig) == "25med" and str(chain) == "tracktwo":
			plotsfile = os.path.join("./","eff_"+str(variable)+"_BDT_tau25med_"+str(trax)+"_tight_SYS.root")
                        h_ratio_MC_graph_chain.SetName("BDT_mc_"+str(trax))
			h_ratio_graph_chain.SetName("BDT_data_"+str(trax))
                elif str(trig) == "tracktwo" and str(chain) == "ptonly":
                        plotsfile = os.path.join("./","eff_"+str(variable)+"_tracking_tau25med_"+str(trax)+"_tight_SYS.root")
                        h_ratio_MC_graph_chain.SetName("tracking_mc_"+str(trax))
			h_ratio_graph_chain.SetName("tracking_data_"+str(trax))

                elif str(trig) == "ptonly" and str(chain) == "L1TAU12IMmed":
                        plotsfile = os.path.join("./","eff_"+str(variable)+"_ptcut_tau25med_"+str(trax)+"_tight_SYS.root")
