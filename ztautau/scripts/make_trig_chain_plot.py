...
leg_eff.AddEntry(L1_eff_data_3Track,"Data",'P')
...
tlatex.DrawLatex(0.35,0.45,'1-prong')#, #sqrt{s} = 13 TeV')
...
tlatex.SetTextFont(42)
tlatex.SetTextSize(0.1)
tlatex.DrawLatex(0.35,0.32,'1-prong')
...
tlatex.SetNDC()
tlatex.SetTextFont(42)
tlatex.SetTextSize(0.075)
tlatex.DrawLatex(0.35,0.32,'3-prong')
