...
leg_eff = ROOT.TLegend(0.45,0.15,0.87,0.45) #ROOT.TLegend(legXMin,legYMin,legXMax,legYMax)
leg_eff.SetBorderSize(0)
leg_eff.SetFillColor(0)
leg_eff.SetFillStyle(0)
leg_eff.SetNColumns(2)
leg_eff.SetTextSize(0.08)
...
leg_chain = ROOT.TLegend(0.45,0.15,0.87,0.35) #ROOT.TLegend(legXMin,legYMin,legXMax,legYMax)
leg_chain.SetBorderSize(0)
leg_chain.SetFillColor(0)
leg_chain.SetFillStyle(0)
leg_chain.SetNColumns(2)
leg_chain.SetTextSize(0.08)
leg_chain.AddEntry(PTcut_3p_data,"Data",'P')
leg_chain.AddEntry(PTcut_3p_MC,"MC",'F')
...
tlatex.DrawLatex(0.5,0.5,'1-prong')
tlatex.DrawLatex(0.5,0.6,"#bf{#it{ATLAS}} Internal")
...
yaxis_bot4.SetTitleOffset(0.72)
...
tlatex.SetTextFont(42)
tlatex.SetTextSize(0.08)
tlatex.DrawLatex(0.5,0.5,'3-prong')
tlatex.DrawLatex(0.5,0.6,"#bf{#it{ATLAS}} Internal")
