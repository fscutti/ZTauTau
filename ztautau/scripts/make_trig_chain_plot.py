...
xaxis_bot1.SetRangeUser(25,300)
...
tlatex.DrawLatex(0.2,0.4,'HLT tau25 medium trigger, 1-prong')
tlatex.DrawLatex(0.2,0.6,'#bf{#it{ATLAS}} Internal, 33.3 fb^{-1}, #sqrt{s} = 13 TeV')
#tlatex.DrawLatex(0.35,0.35,'1-prong')#, #sqrt{s} = 13 TeV')
...
xaxis_bot2.SetRangeUser(25,300)
yaxis_bot2.SetRangeUser(0,1.02)
...
xaxis_bot3.SetRangeUser(25,300)
yaxis_bot3.SetRangeUser(0.7,1.02)
...
xaxis_bot4.SetRangeUser(25,300)
yaxis_bot4.SetRangeUser(0.75,1.02)
...
xaxis_bot5.SetRangeUser(25,300)
...
tlatex.DrawLatex(0.33,0.4,'3-prong')
...
xaxis_bot6.SetRangeUser(25,300)
yaxis_bot6.SetRangeUser(0,1.02)
...
xaxis_bot7.SetRangeUser(25,300)
yaxis_bot7.SetRangeUser(0.7,1.02)
...
xaxis_bot8.SetRangeUser(25,300)
yaxis_bot8.SetRangeUser(0.75,1.02)
