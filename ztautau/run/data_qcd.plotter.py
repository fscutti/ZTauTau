...
def analyze(config):
    ...
    for c in comb:
        if c[0] == 'mu': 
            ...
            cutflow[c[0]][c[1]][c[2]] += [['OS', None] , ['LepIso',     ['MuIsoGrad']], ['TauID',        ['TauID']]]
            antiiso[c[0]][c[1]][c[2]] += [['OS', None] , ['LepAntiIso', None         ], ['TauID',        None     ]]
            sswjtcr[c[0]][c[1]][c[2]] += [['SS', None] , ['LepIso',     None         ], ['TauID',        None     ]]
            osaidcr[c[0]][c[1]][c[2]] += [['OS', None] , ['LepIso',     None         ], ['TauLooseNMed', None     ]]
            base_cuts = [
                        #['OS'           , None] ,
                        ['LepPt'        , ['MuTTVA']] , 
                        ['LepQual'      , ['MuRecoID']] ,
        ...
        if c[0] == 'el': 
            ...
            cutflow[c[0]][c[1]][c[2]] += [['OS', None] , ['LepIso',     ['ElIsoGrad']], ['TauID',        ['TauID']]]
            antiiso[c[0]][c[1]][c[2]] += [['OS', None] , ['LepAntiIso', None         ], ['TauID',        None     ]]
            sswjtcr[c[0]][c[1]][c[2]] += [['SS', None] , ['LepIso',     None         ], ['TauID',        None     ]]
            osaidcr[c[0]][c[1]][c[2]] += [['OS', None] , ['LepIso',     None         ], ['TauLooseNMed', None     ]]
            base_cuts = [
