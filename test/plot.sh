...
python ../ztautau/scripts/merge.py --var="output_BDT"     --reg="presel_muallinc" --lab="TEST REGION" --icut="15" --input="/coepp/cephfs/share/atlas/LFV/hists_ff_presel_v1_mva_v3" --output="./" --makeplot=False
python ../ztautau/scripts/merge.py --var="output_comb"    --reg="presel_muallinc" --lab="TEST REGION" --icut="15" --input="/coepp/cephfs/share/atlas/LFV/hists_ff_presel_v1_mva_v3" --output="./" --makeplot=False
python ../ztautau/scripts/merge.py --var="output_Z"       --reg="presel_muallinc" --lab="TEST REGION" --icut="15" --input="/coepp/cephfs/share/atlas/LFV/hists_ff_presel_v1_mva_v3" --output="./" --makeplot=False
python ../ztautau/scripts/merge.py --var="output_W"       --reg="presel_muallinc" --lab="TEST REGION" --icut="15" --input="/coepp/cephfs/share/atlas/LFV/hists_ff_presel_v1_mva_v3" --output="./" --makeplot=False
python ../ztautau/scripts/merge.py --var="NN_input_mcoll" --reg="presel_muallinc" --lab="TEST REGION" --icut="15" --input="/coepp/cephfs/share/atlas/LFV/hists_ff_presel_v1_mva_v3" --output="./" --makeplot=False
